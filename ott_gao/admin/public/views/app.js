define([
    ...
    css: "header",
		elements:[
			...
			{view: "template", borderless: true, css: "logo", template: "<a href='http://gao.easyvideo.vn'><img class='photo' src='assets/imgs/gao_logo_h39.png' /><img class='photo' heigth=39 style='padding-left:5px;' src='assets/imgs/saobacdau_logo_39.png' /></a>", width: 200},
			{ height:46, id: "person_template", css: "header_person", borderless:true, width: 180, data: {id:3,name: "Admin"},
				template: function(obj){
					...
					html += "<img class='photo' src='assets/imgs/no_avatar_profile.png' /><span class='name'>"+obj.name+"</span>";
	...
	return {
		...
		$oninit:function(view, scope){
			...
			scope.ui(message.$ui);
			scope.ui(profile.$ui);
			$$('profilePopup').attachEvent('onItemClick', function(id){
				switch(id) {
					case '4': Meteor.logout();
						break;
				}
			})
		}
