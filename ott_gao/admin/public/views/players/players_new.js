define(["views/webix/ckeditor"], function(){
	...
	var layout = {
		...
		elements:[
			...
			{view: "text", name: "customLogoLink", label: "Logo Link"},
			...
			{view: "colorpicker", name: "ctaButtonButtonTextFormatColor", label: "Button Text Color"},
			...
			$$("customLogoUrl_button").attachEvent("onItemClick", function () {
				$$("uploadAPI").fileDialog({
					cb: function (response) {
						...
						$$('players_new').setValues({customLogoUrl: url}, true);
					}
				});
			})
			...
			$$("bottomLogoUrl_button").attachEvent("onItemClick", function () {
				$$("uploadAPI").fileDialog({
					cb: function (response) {
						...
						$$('players_new').setValues({bottomLogoUrl: url}, true);
					}
				});
			})
