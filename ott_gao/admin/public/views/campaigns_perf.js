define([
    ...
    var grid = {
        ...
        rows: [
            {
                id: "campaigns_perf_table",
                view: "datatable", select: true,
                columns: [
                    {id: "label", header: "Campaign", fillspace:true},
                    {id: "visits", header: "Visits", width:100},
                    {id: "orders", header: "Orders", width: 100},
                    {id: "cr", header: "CR", width: 100},
                    {id: "revenue", header: "Revenue", width: 100},
                    {id: "pev", header: "PEV", width: 100},
                    //{
                    //    id: "employee",
