...
for f in vbxapp.js vbxapp.min.js vbxapp.css ;do
	/usr/bin/curl -A 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/46.0.2490.71 Safari/537.36' $p/app/$v/$f -o app/$v/$f
done
mkdir -p $od
for f in fizz.css vbxapp.css vbxlayout.css jolt.css common.css viewbix.css;do
