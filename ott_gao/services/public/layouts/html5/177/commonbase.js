...
function bodyClass(customLogoUrl, title, ctaText, showViewbixBranding, showFacebookButton, showTwitterButton, showShareButton, keepControlsVisible, backgroundImage) {
    var classes = {
        remove: "",
        add: ""
    };
...
function updateMenu() {
    if (menuOnBottom) {
        ...
        var menuBottom = bottomLogoHeight + (showViewbixBranding ? 10 : 0);
...
function updateVideoSize() {
    ...
    if (menuOnBottom) {
        ...
        appsHeight = (bodyHeight - bottomSliceHeight - viewbixBrandingHeight - appsTop - menuHeight);
    } else {
        appsHeight = (bodyHeight - bottomSliceHeight - viewbixBrandingHeight - appsTop);
    }
