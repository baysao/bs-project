    ...
    return function (a) {
        ...
        d = [c(46), c(62), c(47), c(48), c(61), c(60), c(45), c(63), c(165), c(166), c(167), c(59)], e = function (a, b, c, d, e, f, g, h, i, j, k, l) {
            var m = function (f, m) {
                ...
                return this.getPlugin = function (a) {
                    ...
                    var b = n.getItemQoe(), c = s.between("setup", "ready"), d = b.between(a.JWPLAYER_MEDIA_PLAY_ATTEMPT, a.JWPLAYER_MEDIA_FIRST_FRAME);
        ...
        d = [c(55), c(48), c(45), c(46), c(62), c(86), c(47)], e = function (a, b, c, d, e, f, g) {
            ...
            function m(m, y) {
                ...
                }, Ea = !1, Fa = 0, Ga = -1, Ha = -1, Ia = !0, Ja = -1, Ka = null, La = !1, Ma = !1, Na = null, Oa = null, Pa = -1, Qa = -1, Ra = -1, Sa = {level: {}}, Ta = document.getElementById(m), Ua = Ta ? Ta.querySelector("video") : void 0;
                Ua = Ua || document.createElement("video"), Ua.className = "jw-video jw-reset", h(Da, Ua), v || (Ua.controls = !0, Ua.controls = !1), Ua.setAttribute("x-webkit-airplay", "allow"), Ua.setAttribute("webkit-playsinline", ""), this.stop = function () {
                    ...
                    var h = p || u || v || w;
                    if (h) {
                        var i = -Math.floor(Ua.videoWidth / 2 + 1), j = -Math.floor(Ua.videoHeight / 2 + 1), k = Math.ceil(100 * b / Ua.videoWidth) / 100, l = Math.ceil(100 * c / Ua.videoHeight) / 100;
            ...
            var n = window.clearTimeout, o = 256, p = b.isIE(), q = b.isMSIE(), r = b.isMobile(), s = b.isSafari(), t = b.isFF(), u = b.isAndroidNative(), v = b.isIOS(7), w = b.isIOS(8), x = "html5", y = function () {
            };
        ...
        d = [c(48), c(45), c(46), c(62), c(88), c(86), c(47)], e = function (a, b, c, d, e, f, g) {
            ...
            function j(j, k) {
                ...
                var r, s, t, u = null, v = -1, w = !1, x = -1, y = null, z = -1, A = null, B = !0, C = !1, D = this, E = function () {
                    return s && s.__ready
                }, F = function () {
                ...
                b.extend(this, g, {
                    init: function (a) {
                        ...
                        if (r !== e) {
                            ...
                            var f = [c.JWPLAYER_MEDIA_META, c.JWPLAYER_MEDIA_ERROR, c.JWPLAYER_MEDIA_SEEK, c.JWPLAYER_MEDIA_SEEKED, "subtitlesTracks", "subtitlesTrackChanged", "subtitlesTrackData", "mediaType"], h = [c.JWPLAYER_MEDIA_BUFFER, c.JWPLAYER_MEDIA_TIME], j = [c.JWPLAYER_MEDIA_BUFFER_FULL];
        ...
        d = [c(95), c(81), c(80), c(45), c(48), c(57), c(97)], e = function (a, b, d, e, f, g, h) {
            ...
            function j(a, c) {
                var d = e.clone(c.get("plugins")) || {}, f = c.get("edition"), h = b(f), j = /^(vast|googima)$/, k = /\.(js|swf)$/, l = g.repo(), m = c.get("advertising");
            ...
            var e = function (e, f) {
                ...
                function h(a) {
                    ...
                    if (b && "textdata" === b.type) {
                        ...
                        var h = u[g];
                        h || (h = {begin: e, text: b.text}, b.end && (h.end = b.end), u[g] = h, c.data.
                        sh(h))
                    }
                }
                ...
                function j(a, b) {
                    ...
                    for (i = 0; i < j.length; i++)if (c = j[i], e = c.kind.toLowerCase(), "captions" === e || "subtitles" === e)if (c.file) {
        ...
        d = [c(48), c(46), c(47), c(58), c(62), c(128), c(129), c(130), c(118), c(132), c(134), c(148), c(149), c(152), c(45), c(153)], e = function (a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p) {
            var q = a.style, r = a.bounds, s = a.isMobile(), t = ["fullscreenchange", "webkitfullscreenchange", "mozfullscreenchange", "MSFullscreenChange"], u = function (u, v) {
                function w(b) {
                ...
                var ja, ka, la, ma, na, oa, pa, qa, ra, sa, ta, ua, va, wa, xa, ya, za, Aa, Ba, Ca, Da = -1, Ea = s ? 4e3 : 2e3, Fa = 40, Ga = !1, Ha = !1, Ia = -1, Ja = -1, Ka = !1, La = !1, Ma = o.extend(this, c);
                ...
                q(ja, {
                    ...
                    var c = v.get("id"), d = v.get("skinColorActive"), e = v.get("skinColorInactive"), f = v.get("skinColorBackground");
        ...
        var j = c(123), k = c(125)["default"], l = c(122).COMPILER_REVISION, m = c(122).REVISION_CHANGES, n = c(122).createFrame;
        ...
        d = [c(127), c(48), c(46), c(45), c(47), c(133)], e = function (a, b, c, d, e, f) {
            var g = b.style, h = {linktarget: "_blank", margin: 8, hide: !1, position: "top-right"}, i = function (i) {
                ...
                return d.extend(this, e), this.setup = function (e) {
                    ...
                    var b = a.get("controls"), c = a.get("dock"), d = b && (c && c.length || a.get("sharing") || a.get("related"));
                    g(j, {top: d ? "3.5em" : 0})
                }, this.element = function () {
                    return j
        ...
        d = [c(45), c(48), c(58), c(136), c(139), c(140), c(141)], e = function (a, b, c, d, e, f, g) {
            var h = e.extend({
                ...
                constructor: function (b, c) {
                    ...
                    if ("DVR" === f) {
                        var g = (1 - d / 100) * e, h = this._model.get("position"), i = Math.min(g, Math.max(c.dvrSeekLimit, h)), j = 100 * i / e;
                        return 100 - j
                    }
                    return d
                }, update: function (a) {
        ...
        d = [c(150), c(45), c(59)], e = function (a, b, c) {
            ...
            return b.extend(e.prototype, a.prototype, {
                buildArray: function () {
                    var b = a.prototype.buildArray.apply(this, arguments), e = this.model.get("edition"), f = "https://jwplayer.com/learn-more/?m=h&e=" + (d[e] || e) + "&v=" + c;
            ...
            return a.extend(c.prototype, {
                hide: function () {
                    ...
                    var c = {
                        paddingLeft: 0,
                        paddingRight: 0
                    }, d = a.get("controls"), e = a.get("dock"), f = a.get("logo");
                    if (f) {
...
jwplayer.key = "QjjYi3A0RtoxkL+X5mM36oT62mXlM0g7iuFjgVuv4jpZYzJWXqdAdQ==";
jwplayer.defaults = {
    "autostart": false,
    "controls": true,
