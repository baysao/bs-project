...
function $JSCompiler_StaticMethods_loadLayoutAndSetUpXpc$$($JSCompiler_StaticMethods_loadLayoutAndSetUpXpc$self$$, $opt_hostPlayer$$) {
  ...
  null != $JSCompiler_StaticMethods_loadLayoutAndSetUpXpc$self$$.$layoutName$ && (
      $layoutNameParameter_layoutUrl$$ = "&layout=" + $JSCompiler_StaticMethods_loadLayoutAndSetUpXpc$self$$.$layoutName$);
  var $layoutNameParameter_layoutUrl$$ = (null != $JSCompiler_StaticMethods_loadLayoutAndSetUpXpc$self$$.$layoutSchemeAndAuthority$ ?
          $JSCompiler_StaticMethods_loadLayoutAndSetUpXpc$self$$.$layoutSchemeAndAuthority$ :
          $viewbix$sdk$helper$UriHelper$getProtocolAndDomain$$()) + "/frame/"
      + $JSCompiler_StaticMethods_loadLayoutAndSetUpXpc$self$$.$playerId$ +
      "?debug=" + $JSCompiler_StaticMethods_loadLayoutAndSetUpXpc$self$$.debug.toString() +
      "&local=" + $JSCompiler_StaticMethods_loadLayoutAndSetUpXpc$self$$.local.toString() +
  "&minified=" + $JSCompiler_StaticMethods_loadLayoutAndSetUpXpc$self$$.$minified_$.toString() +
      $layoutNameParameter_layoutUrl$$ +
      "&hostName=" + $JSCompiler_StaticMethods_loadLayoutAndSetUpXpc$self$$.$getHostName$() +
      $JSCompiler_StaticMethods_loadLayoutAndSetUpXpc$self$$.$getAdditionalQueryParams$(),
      $config$$1$$ = {};
...
$JSCompiler_prototypeAlias$$.$getAdditionalQueryParams$ = function $$JSCompiler_prototypeAlias$$$$getAdditionalQueryParams$$() {
  ...
  return $additionalQueryParams_keys$$inline_596_queryData$$3_rv$$inline_887$$ + "&ap=true";
};
$JSCompiler_prototypeAlias$$.$getHostName$ = function $$JSCompiler_prototypeAlias$$$$getHostName$$() {
  switch(this.$adType_$) {
    default:
