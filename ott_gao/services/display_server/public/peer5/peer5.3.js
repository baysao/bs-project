!function () {
    ...
    i.core = {
        ...
        var n = !1, r = i.config ? i.config.LOG_LEVEL : 2, s = ["0", "ERROR", "WARNING", "info", "log", "debug"], o = function (s, o) {
            if (!(s > r)) {
                2 >= s && !n && i.logString && (i.logString += e(s, o) + "\n");
                var a = n ? e(s, o) : new t(s, o);
                switch (s) {
                    case 1:
                        console.error(a);
                        break;
    ...
    !function (e) {
        ...
        function i(t) {
            this.tag = e.P2P_LATENCY_REQUEST, this.timestamp = t
        }

        function r(t, n) {
            this.tag = e.P2P_LATENCY_RESPONSE, this.timestamp = t, this.bufferedAmount = n
        }
        ...
        function b(e, t, n, i, r, s, o, a, c, l) {
        ...
        e.P2P_DATA = 17, e.P2P_REQUEST = 18, e.P2P_CANCEL = 19, e.P2P_HAVE = 20, e.P2P_HAVE_REQUEST = 21, e.P2P_DONT_HAVE = 22, e.P2P_VERSION = 23, e.P2P_LATENCY_REQUEST = 24, e.P2P_LATENCY_RESPONSE = 25, e.FILE_INFO = 34, e.JOIN = 36, e.LEAVE = 37, e.CLOSE = 38, e.SWARM_HEALTH = 41, e.SWARM_ERROR = 48, e.SDP = 49, e.COMPLETED_DOWNLOAD = 50, e.GROUP_REPORT = 51, e.GROUP_MATCH = 52, e.HEAD = 53, e.HEAD_RESPONSE = 54, e.HEAD_ERROR = 55, e.GROUP_JOIN = 56, e.HEARTBEAT = 57, e.SHARE = 59, e.LEECH = 60, e.GROUP_SDP = 61, e.SWARM_NOT_FOUND = 0, e.SWARM_ONLY_DEVCHANNEL = 1, e.SWARM_ONLY_FIREFOX = 11, e.SWARM_ONLY_CHROME = 12, e.SWARM_NOT_COMPAT = 13, e.Have = o, e.HaveRequest = c, e.DontHave = a, e.Cancel = s, e.Request = n, e.Data = t, e.Version = C, e.LatencyRequest = i, e.LatencyResponse = r, e.GroupReport = d, e.SwarmReport = u, e.Connection = b, e.FileInfo = m, e.Share = _, e.GroupMatch = v, e.Join = h, e.Leech = f, e.GroupJoin = p, e.Leave = g, e.Sdp = S, e.GroupSdp = T, e.SwarmHealth = R, e.SwarmError = E, e.Head = w, e.HeadResponse = A, e.HeadError = P, e.Heartbeat = l
        ...
        var o = 1, a = 4, c = function (e) {
            ...
            var t = l(r.packSwarmId(e.swarmId)), n = f(e.chunkId);
            ...
            var t = [];
            return t.push(f(e.timestamp)), t.push(f(e.bufferedAmount)), r.concat(t)
        }, R = function (e, t, n) {
            var i = h(e, t);
            return new s.LatencyRequest(i)
        }, w = function (e, t, n) {
            var i = h(e, t);
            t += 4;
            var r = h(e, t);
            return t += 4, new s.LatencyResponse(i, r)
        }, A = function (e, t, n) {
            ...
            for (var o = []; n > 0;)o.push(h(e, t)), n -= 4, t += 4;
            ...
            if (t++, n--, !d) {
                var u = g(e, t);
                if (t++, n--, u)o = e.slice(t, t + n); else for (i = []; n > 0;)i.push(h(e, t)), t += 4, n -= 4
            }
            return new s.Have(a, d, o, i, l)
        }, I = function (e, t, n) {
            var i = c(e.slice(t, t + r.transferedSwarmIdSize));
            t += r.transferedSwarmIdSize, n -= r.transferedSwarmIdSize;
            ...
            return JSON.parse(r)
        }, N = {encode: O, decode: k}, M = {encode: L, decode: D}, F = {};
        F[s.P2P_DATA] = {encode: m, decode: A}, F[s.P2P_REQUEST] = {encode: _, decode: P}, F[s.P2P_CANCEL] = {
            encode: E,
            decode: C
        }, F[s.P2P_HAVE] = {encode: v, decode: y}, F[s.P2P_DONT_HAVE] = {
            encode: b,
            decode: I
        }, F[s.P2P_LATENCY_REQUEST] = {encode: S, decode: R}, F[s.P2P_LATENCY_RESPONSE] = {
            encode: T,
            decode: w
        }, F[s.P2P_VERSION] = N, F[s.P2P_HAVE_REQUEST] = N, F[s.REPORT] = N, F[s.MATCH] = N, F[s.SDP] = N, F[s.FILE_INFO] = M, F[s.SWARM_HEALTH] = N, F[s.SWARM_ERROR] = N, F[s.JOIN] = N;
        var U = function (e, t, n, i) {
            var r = n;
            i && t in F && F[t].encode && (r = F[t].encode(n));
            var s = new Uint8Array(5 + r.length), o = r.length;
            return s[e++] = t, s.set(f(o), e), e += a, s.set(r, e), s
        }, x = function (e, t) {
            var n = e[t++], i = h(e, t);
            t += a;
            var r = e.slice(t, t + i);
        ...
        r.concat = function (e) {
            ...
            return e.forEach(function (e) {
                if (e && e.tag && F[e.tag] && F[e.tag].encode) {
                    var n = F[e.tag].encode(e);
                    t.push(U(0, e.tag, n))
                }
            }), r.concat(t)
        }, r.decode = function (e) {
            for (var t = 0, n = []; t < e.length;) {
                var i = x(e, t), r = i[0], s = i[1];
                t += o + a;
                var c = F[r];
            ...
            readFileInSlices: function (e, t, n, r) {
                ...
                o.onloadend = function (c) {
                    c.target.readyState == FileReader.DONE && (i.log("onload returned: " + o.readyState), r(e, c.target.result, function () {
                        a++, (a + 1) * n < t.size ? (s = t.slice(a * n, (a + 1) * n), 1 == o.readyState && i.error("onloadend in file: " + t + " readyState==1"), i.log("before reading: " + o.readyState), o.readAsArrayBuffer(s)) : a * n < t.size ? (s = t.slice(a * n, t.size), o.readAsArrayBuffer(s)) : (i.debug("Finished reading file " + e), r(e))
                    }))
        ...
        window.addEventListener("message", function (e) {
            ...
            for (var t = 0, n = 0, i = 0, r = 0, s = e.slice().sort(), o = 1, a = s.length; a > o; o++)s[o] === s[o - 1] + 1 ? (r++, r > i && (i = r, t = o - r, n = o)) : r = 0;
            return s.slice(t, n + 1)
        ...
        function t() {
            ...
            function o(e) {
                ...
                for (var t = [], i = 0, r = null, s = 0; s < e.length; s++) {
                    var o = e[s];
                    if (o.type === n)r || (r = o.timeStamp), t.push(1); else if (t.pop(), 0 === t.length) {
                        var a = o.timeStamp - r;
                        i += a, r = null
                    }
                }
            ...
            function a() {
                var e = Object.keys(c), t = i.clientInstance.controller.getNumberOfConnectedPeers();
                if (0 !== t) {
                    var n = [], r = Date.now();
        ...
        window.RTCPeerConnection = window.RTCPeerConnection || window.webkitRTCPeerConnection || window.mozRTCPeerConnection, window.RTCSessionDescription = window.RTCSessionDescription || window.mozRTCSessionDescription, window.RTCIceCandidate = window.RTCIceCandidate || window.mozRTCIceCandidate, i.core.transport.PeerConnectionImpl = i.core.transport.AbstractPeerConnection.subClass({
            name: "peer5.core.transport.PeerConnectionImpl", ctor: function (e, t, n, r) {
                ...
                } else i.info("dataChannel was not ready, setting timeout"), t > 0 && (t--, setTimeout(this._send.bind(this), i.config.PC_RESEND_INTERVAL, e, t))
            }, close: function () {
                ...
                if (this.sdpQueue.push(e), this.sdpQueue.length === i.config.PC_SDP_FLUSH_LENGTH)this.flushSdpMessageQueue(); else if (!this.sdpQueueTimer) {
                    var t = this;
                ...
                this.initiatePeerConnectionCallbacks(), this.createPeerConnection(), e && this.ensureHasDataChannel()
                ...
                }, this.addIceCandidateSuccessCallback_ = function (e) {
                }, this.addIceCandidateFailureCallback_ = function (e) {
                ...
                i.info("createDataChannel"), this.dataChannel = this.peerConnection.createDataChannel(this.label, this.dataChannelOptions), i.debug("DataChannel with label " + this.dataChannel.label + " initiated locally."),
                ...
                if (t.length > 1)var n = t[0] + "b=AS:1638400" + t[1]; else n = e;
                return n
            ...
            for (var e, t = i.config.STUN_SERVERS, n = i.config.TURN_SERVERS ? i.config.TURN_SERVERS : [], r = i.config.TURN_CREDENTIALS, s = {iceServers: []}, o = 0; o < t.length; ++o)s.iceServers.push({urls: "stun:" + t[o]});
            for (var a = 0; a < n.length; ++a)s.iceServers.push({urls: "turn:" + n[a], credential: r[a]});
            try {
                i.info("creating peerConnection"), e = new RTCPeerConnection(s)
            } catch (c) {
        ...
        i.core.stats.StatsCalculator = Object.subClass({
            name: "peer5.core.stats.StatsCalculator", ctor: function () {
        ...
        function t() {
            function e(e) {
                var t = {action: e.action};
                return e.occurrence && (t.occurrence = e.occurrence), e.vendor && (t.vendor = e.vendor), e.duration && (t.duration = e.duration), e.timeSinceLoaded && (t.timeSinceLoaded = e.timeSinceLoaded), e.timeSinceReady && (t.timeSinceReady = e.timeSinceReady), t
            }
            ...
            function t(t) {
                if (i.config.FEATURE_REPORT_PLAY_VS_REBUFFER) {
                    ...
                    if ("pause.end" === t.action)return u.push({action: n, timeStamp: s}), null;
                    "rebuffer.start" === t.action ? (h.push({action: n, timeStamp: s}), u.push({
                        action: r,
                        timeStamp: s
                    })) : "rebuffer.end" === t.action && (h.push({action: r, timeStamp: s}), u.push({
                        action: n,
                        timeStamp: s
                    }))
                }
            ...
            function s(e, t) {
                for (var i = 0, s = 1; s < e.length; s++) {
                    var o = e[s], a = e[s - 1];
                    o.action === r && (i += o.timeStamp - a.timeStamp)
                }
                var c = e[e.length - 1];
            ...
            function l() {
                var e = Date.now(), t = o(e), n = a(e);
                if (c(e), 0 === t && 0 === n)return null;
                var i = {vendor: p, action: "durations"};
                return t > 0 && (i.playDuration = t), n > 0 && (i.rebufferDuration = n), i
            }

            var d = Date.now(), u = [{action: r, timeStamp: d}], h = [{action: r, timeStamp: d}], f = d, p = null;
            return {handle: t, prepareIntervalReport: l}
        }

        var n = !0, r = !1;
        e.PlayerEventsHandler = t()
    }(i.core.stats), function () {
        i.core.stats.ReportBuilder = Object.subClass({
            name: "peer5.core.stats.reportBuilder", ctor: function () {
                ...
                if (this.currentReport = {}, e.swarms)for (var t = e.swarms, n = Object.keys(t), r = 0, s = n.length; s > r; r++) {
                    var o = n[r], a = this.getSwarmFileSize(o);
                    a && (t[o].fileSize = a), t[o].peers = i.clientInstance.controller.P2PController.getSwarmPeersCount(o)
                }
        ...
        function t() {
            function e(e) {
                if (!s[e]) {
                    ...
                    t.slots = 0, t.loaded = 0, t.endedIntervalsDuration = 0, t.currIntervalStart = null, t.speed = void 0, t.nbProgress = 0, t.lastProgress = null, s[e] = t
                }
                var n = s[e];
            ...
            function n(e, t) {
                var n = performance.now(), r = s[e];
                r.loaded += t, r.nbProgress++;
                var c = n - r.currIntervalStart + r.endedIntervalsDuration;
                r.speed = r.loaded / (c / 1e3);
                var l, d, u;
                r.lastProgress && (d = 1e3 * t / (n - r.lastProgress), o.push(d), o.length > a && o.shift(), u = i.core.util.average(o), l = i.core.data.BlockCache.get(e).fileSize, r.predictedSpeed = l / ((l - r.loaded) / u + c / 1e3)), r.lastProgress = n, i.log(r.nbProgress + " avg speed " + r.speed + " predicted speed " + r.predictedSpeed + " loaded so far " + r.loaded + " size " + t + " total " + l + " bw " + d + " url " + e)
            }
            ...
            var s = Object.create(null), o = [], a = i.config.BANDWIDTH_SLIDING_WINDOW;
            return radio("xhrSent").subscribe([e, this]), radio("xhrLoadend").subscribe([t, this]), radio("xhrBytesReceived").subscribe([n, this]), {getSpeed: r}
        }

        e.HttpStats = t()
    }(i.core.stats), function () {
        i.core.stats.StatsCollector = Object.subClass({
            name: "peer5.core.stats.StatsCollector", ctor: function () {
                this.statsEvents = {
        ...
        var e = i.core.util.UrlSwarmIdMap, t = 1, n = 2;
        ...
        var e = i.core.dataStructures.PendingBlockMap, t = 1, n = 2, r = [], s = !1;
        document.addEventListener("DOMContentLoaded", function () {
            var e = 0, t = setInterval(function () {
                i.info("creating peerConnection for pool"), r.push(i.core.transport.PeerConnectionImpl.createPeerConnection()), e++, (e > i.config.PC_POOL_SIZE || s) && clearInterval(t)
            ...
            ctor: function (e) {
                ...
                var t = Date.now(), r = i.core.data.BlockCache.get(e);
                if (!r)return !1;
                for (var s in this.peerConnections)if (this.remoteAvailabilityMaps[e][s] && this.isPeerAvailable(s))return this.availableTimeStamp = t, !0;
                ...
                this.expireChunks = function (n, r, s, o, a) {
                    ...
                    for (var r = 0; r < n.length; ++r) {
                        ...
                        switch (s.tag) {
                            ...
                            case i.core.protocol.P2P_LATENCY_REQUEST:
                                var d = s.timestamp, u = this.peerConnections[t] ? this.peerConnections[t].getBufferedAmount() : 0, h = new i.core.protocol.LatencyResponse(d, u), f = i.core.protocol.BinaryProtocol.encode([h]);
                                this.sendToPeer(t, f);
                                break;
                            case i.core.protocol.P2P_LATENCY_RESPONSE:
                                this.receiveLatencyMessage(s, t);
                                break;
                            default:
                    ...
                    if (this.peerConnections[e])i.warn("peerConnection to " + e + " was initialized, but we already have a connection to him"); else {
                        ...
                        this.sendQueues[e].canrun = function () {
                            ...
                            return i > n ? !1 : !0
                        }.bind(this), t.peersPerformanceTracker.reportPeerConnected(e), radio("activePeerConnectionsNumberChanged").broadcast(Object.keys(this.peerConnections).length)
                    }
                    this.peerSwarms[e] = Object.create(null), this.sendVersionToNewConnection(e), this.sendHaveToNewConnection(e)
                    ...
                    if (t && t.initiator) {
                        if ("exponential" === i.config.PC_RECON_METHOD)var n = 1e3 * Math.pow(i.config.PC_RECON_EXP_COEF, this.attemptedConnections[e] - 1); else {
                            if ("single" !== i.config.PC_RECON_METHOD)return;
                            if (this.attemptedConnections[e] > 1)return;
                            var n = i.config.PC_RECON_DELAY || 1e4
                        }
                        i.debug("delay for reconnecting with " + e + " = " + n), setTimeout(this.ensurePeerConnectionInitialized.bind(this), n, e, !0)
                    }
                    ...
                    e.sdp.forEach(function (t) {
                        radio("receivedSDP").broadcast({originId: e.originId, destId: e.destId, sdpMessage: t})
                    }, this)
                ...
                !this.latencyInterval && i.config.PC_LATENCY_ENABLED && (this.latencyInterval = setInterval(function () {
                    var t = Math.floor(performance.now()), n = new i.core.protocol.LatencyRequest(t);
                    e.sendToAll(n)
                ...
                for (var n in this.pendingResources)if (n !== e && this.prefetchFlag[n] && void 0 !== this.remoteAvailabilityMaps[n][t]) {
                ...
                var n = Math.floor(performance.now()), i = e.timestamp, r = e.bufferedAmount, s = Math.round(n - i), o = this.peerConnections[t];
                o && (!o.lastLatencyTimestamp || o.lastLatencyTimestamp < i) && (o.lastLatencyTimestamp = i, o.latency = s, o.bufferedAmount = r)
                ...
                var r, s = this;
                if (i.debug("chunks to distribute " + t.length), n)r = [n]; else {
                    var o = Object.keys(this.remoteAvailabilityMaps[e]).filter(function (e) {
                        return "undefined" != typeof s.peerConnections[e] && !s.peerConnections[e].isFull()
                    });
                    r = o.sort(function (e, t) {
                        var n = s.peerConnections[e].numOfPendingChunks, i = s.peerConnections[t].numOfPendingChunks;
                        return n > i
                    })
                }
                for (var a, c = Object.create(null), l = 0, d = 0; d < t.length; ++d)for (var u = t[d], h = Math.floor(u / (i.config.BLOCK_SIZE / i.config.CHUNK_SIZE)), f = 0; f < r.length; ++f)if (a = i.config.PC_ALLOCATE_CHUNKS_EVENLY ? r[(f + d) % r.length] : r[f], this.remoteAvailabilityMaps[e][a] && this.remoteAvailabilityMaps[e][a].has(h) && !this.peerConnections[a].isFull()) {
                    c[a] || (c[a] = []), c[a].push(u), l++, this.peerConnections[a].numOfPendingChunks++;
                    break
                }
                for (var p = 0; p < r.length; ++p)if (c[r[p]]) {
                    a = r[p], t = c[a], this.addToPendingChunks(e, t, a), this.peerConnections[a].numOfRequestedChunks += t.length;
                    var g = new i.core.protocol.Request(e, t), m = i.core.protocol.BinaryProtocol.encode([g]);
            ...
            }, sendData: function (e, t, n, r, s) {
                if (this.canUpload(e) && !(i.config.EMULATE_LOSS && Math.random() < i.config.EMULATE_LOSS_PERCENTAGE)) {
                    var o = n[r];
                    r++;
                    var a = this, c = i.core.data.BlockCache.get(e);
                    c && c.getChunk(o, function (c, l) {
                        s += l.length;
                        var d = new i.core.protocol.Data(e, o, l), u = i.core.protocol.BinaryProtocol.encode([d]);
                        a.sendToPeer(t, u), r < n.length ? a.sendData(e, t, n, r, s) : (a.peersPerformanceTracker.reportUploadToPeer(t, s), radio("chunkSentEvent").broadcast(e, s))
                    })
                }
                ...
                i.core.data.BlockCache.forEach(function (e, i) {
                    var o = i.metadata;
                    o && s.resourceState[o.swarmId] && (t = o.swarmId, n = s.createHaveMessage(t), r.push(n))
                });
                var o = i.config.CHUNK_SIZE / 76;
                o = Math.floor(.9 * o);
                for (var a = [], c = 0, l = r.length; l > c; c += o) {
                    a = r.slice(c, c + o);
                    var d = i.core.protocol.BinaryProtocol.encode(a);
                    this.sendToPeer(e, d)
                }
            }, sendVersionToNewConnection: function (e) {
                var t = new i.core.protocol.Version("0.54.10", i.config.VERSION), n = i.core.protocol.BinaryProtocol.encode([t]);
                this.sendToPeer(e, n)
            }, receiveHaveMessage: function (e, t) {
                var n = e.swarmId, r = this.remoteAvailabilityMaps[n];
                if (!r)return this.remoteHave[n] = this.remoteHave[n] || {}, void(this.remoteHave[n][t] = e);
                if (!r[t]) {
                    i.info("got a have message from a peer with a non initialized availabilityMap");
                    var s = i.core.data.BlockCache.get(e.swarmId);
                    if (!s)return;
                    r[t] = new i.core.dataStructures.AvailabilityMap(s.getNumOfBlocks())
                }
                e.availabilityMap ? r[t].deserializeAndCopy(e.availabilityMap) : e.seeder ? r[t].setSeeder() : r[t].deserializeAndUpdate(e.blockIds), this.peerSwarms[t] || (this.peerSwarms[t] = Object.create(null)), this.peerSwarms[t][n] = !0
            }, receiveDontHaveMessage: function (e, t) {
                var n = e.swarmId;
                return !this.remoteAvailabilityMaps[n] && this.remoteHave[n] && this.remoteHave[n][t] ? void delete this.remoteHave[n][t] : this.remoteAvailabilityMaps[n] && this.remoteAvailabilityMaps[n][t] ? void delete this.remoteAvailabilityMaps[n][t] : void 0
            ...
            }, receiveP2PChunk: function (t, n, r, s) {
                i.debug("receiving chunk " + r);
                var o = i.core.data.BlockCache.get(t);
                if (o.hasChunk(r) ? (i.log("DOH! I already got chunk: " + r + "!"), radio("peer5_waste_p2p_chunk").broadcast(t, s.length, r)) : (radio("peer5_new_p2p_chunk").broadcast(t, s.length, r), this.addChunk(t, s, r)), this.p2pPendingChunks[t] && this.p2pPendingChunks[t][r]) {
                    var a = Date.now() - this.p2pPendingChunks[t][r], c = this.peerConnections[n];
                    c.minLatencyForChunk ? (c.minLatencyForChunk = Math.min(c.minLatencyForChunk, a), c.maxLatencyForChunk = Math.max(c.maxLatencyForChunk, a), c.avgLatencyForChunk = (c.avgLatencyForChunk * c.numOfChunksArrived + a) / (1 + c.numOfChunksArrived)) : (c.minLatencyForChunk = a, c.maxLatencyForChunk = a, c.avgLatencyForChunk = a), c.numOfChunksArrived++, c.numOfPendingChunks--, delete this.p2pPendingChunks[t][r];
                    var l = o.getBlockIdOfChunk(r);
                    this.p2pPendingChunksInBlock[t][l]--, e.removeChunk(t, r)
                ...
                var s = this.peerConnections[r];
                if (s.avgLatencyForChunk && s.numOfChunksArrived > 5 * s.maxNumOfPendingChunks)var o = (i.config.CHUNK_EXPIRATION_TIMEOUT + 2 * s.avgLatencyForChunk) / 2; else var o = i.config.CHUNK_EXPIRATION_TIMEOUT;
                for (var a = i.core.data.BlockCache.get(t), c = 0; c < n.length; ++c) {
                    var l = n[c], d = a.getBlockIdOfChunk(l);
                    this.p2pPendingChunks[t][l] = Date.now(), this.p2pPendingChunksInBlock[t][d] ? this.p2pPendingChunksInBlock[t][d]++ : this.p2pPendingChunksInBlock[t][d] = 1, e.addChunk(t, l), radio("peer5_p2p_pending_chunk").broadcast(l, t, r)
                }
                if (0 != n.length) {
                    this.requestNum++;
                    var u = setTimeout(this.expireChunks, o, t, n, r, this.requestNum);
                    this.pendingRequests[this.requestNum] = [u, t, n, r]
                }
                ...
                var t = i.core.data.BlockCache.get(e);
                if (t) {
                    var n, r = i.state.resources.get(e), s = r ? r.hashUrl : null;
                    return n = t.isFull() ? new i.core.protocol.Have(e, !0, null, null, s) : new i.core.protocol.Have(e, !1, t.getSerializedMap(), null, s)
                }
            }, createDontHaveMessage: function (e) {
                var t = i.state.resources.get(e), n = t ? t.hashUrl : null, r = new i.core.protocol.DontHave(e, n);
                return r
            }, closeDeadConnections: function (e) {
                var t = (Date.now() - e.peerData.lastHaveReportTimestamp) / 1e3, n = this.peerConnections[e.peerId];
                ...
                this.deletedPeerConnections[e] = this.deletedPeerConnections[e] || this.peerConnections[e] || this.initPeerConnections[e], delete this.peerConnections[e], delete this.initPeerConnections[e], void 0 !== this.sendQueues[e] && (this.sendQueues[e].reset(), delete this.sendQueues[e]), radio("activePeerConnectionsNumberChanged").broadcast(Object.keys(this.peerConnections).length), this.peersPerformanceTracker.reportPeerDisconnected(e)
                ...
                return i.core.util.validateVersion(e.client) && i.core.util.validateVersion(e.conf) ? e.conf !== i.config.VERSION ? (i.warn("Connected to a client with a non matching configuration version"), void this.closeConnection(t, !0)) : 0 !== i.core.util.compareMajorVersionNumbers("0.54.10", e.client) ? (i.warn("Connected to a client with a non matching client major version"), void this.closeConnection(t, !0)) : void(this.peerConnections[t].ignore = !1) : (i.warn("Connected to a client with an invalid version"), void this.closeConnection(t, !0))
            }, initClosePCQueue: function () {
                this.pcCloseQueue = i.core.util.taskQueue();
                var e = 0;
                this.pcCloseQueue.canrun = function () {
                    var t = Date.now() - e, n = i.config.PC_CLOSE_TIMEOUT - t;
                    return 0 > n ? !0 : n
        ...
        i.client.HTTPDownloader = Object.subClass({
            name: "peer5.client.HTTPDownloader", ctor: function (e) {
                if (this.url = e, this.httpRequestTime = 0, this.firstRequest = !0, this.lastTimerTimestamp = null, this.xhr = window._XMLHttpRequest ? new _XMLHttpRequest : new XMLHttpRequest, !this.xhr)throw"Cannot instantiate XHR";
                this.registerEvents()
            }, isHTTPBusy: function () {
                ...
                this.xhr.url = this.url, i.feature.isEnabledAndInitialized(i.config.FEATURE_PROXY_HEAD_KEY) ? this.xhr.open("HEAD", i.config.FEATURE_PROXY_HEAD_URL_PREFIX + encodeURIComponent(this.url).replace(/'/g, "%27").replace(/"/g, "%22")) : this.xhr.open("HEAD", this.url), this.xhr.busy = !0;
                var e = this;
                this.xhr.onload = function (t) {
                    this.busy = !1;
                    var n = this.getAllResponseHeaders();
                    200 === this.status || 206 === this.status ? radio("responseHeadersReceived" + this.url).broadcast(n, "HEAD") : (n.indexOf("X-Peer5-Proxy") > -1 && 404 !== this.status && i.feature.disable(i.config.FEATURE_PROXY_HEAD_KEY), i.warn("Expecting status code 200/206 from HEAD request. Got " + this.status), radio("xhrFailed" + this.url).broadcast(this)), e.stop()
                ...
                if (this.timerId && (clearTimeout(this.timerId), i.debug("resetTimer clearTimeout of " + this.timerId)), this.lastTimerTimestamp) {
                    var n = Date.now() - this.lastTimerTimestamp, r = (e + i.config.XHR_TIMEOUT_FACTOR * n) / 2;
                    e = Math.round(Math.max(i.config.XHR_MINIMUM_TIMEOUT, r))
                }
                this.timerId = setTimeout(this.expireRequest, e, t), this.lastTimerTimestamp = Date.now(), i.debug("resetTimer setTimeout returned " + this.timerId)
            }, download: function (t, n, r) {
                i.info("Downloading in http " + this.url + " start=" + t + " end=" + n), i.debug(t + " - " + n);
                var s = this;
                ...
                this.xhr.busy = !0, n ? this.xhr.setRequestHeader("Range", "bytes=" + t + "-" + n) : t && t > 0 ? this.xhr.setRequestHeader("Range", "bytes=" + t + "-") : t = 0, this.xhr.startRange = t, this.xhr.endRange = n, (!this.xhr.lastTotalLoaded || t > this.xhr.lastTotalLoaded || n < this.xhr.lastTotalLoaded) && (this.xhr.lastTotalLoaded = t), this.xhr.onloadend = function (e) {
                    i.debug("xhr onloadend start: " + this.startRange + " end: " + this.endRange), clearTimeout(s.timerId), this.busy = !1, s.httpRequestTime = 0, this.status < 300 && this.status >= 200 && this.response ? (i.info("xhr onload: " + this.url + "start= " + this.start + "end= " + this.end), radio("bytesReceivedEvent" + this.url).broadcast({
                        url: this.url,
                        offset: this.startRange,
                        dataArray: new Uint8Array(this.response)
                    })) : radio("xhrFailed" + this.url).broadcast(this), radio("xhrLoadend" + this.url).broadcast(e)
                    ...
                    if (this.readyState === this.HEADERS_RECEIVED && (s.resetTimer(this.lastModified), this.onreadystatechange = null, this.status >= 200 && this.status < 300)) {
                        i.log("received headers: " + this.url);
                        var t = this.getAllResponseHeaders();
                        radio("responseHeadersReceived" + this.url).broadcast(t, "GET")
                    }
                }, this.xhr.responseType = "arraybuffer", this.xhr.onprogress = function (t) {
                    var n = Date.now() - this.lastModified;
                    n > e / 2 && i.info("onprogress last part arrived in " + n + "ms"), this.lastModified = Date.now(), s.resetTimer(this.lastModified);
                    var r = t.loaded + t.target.startRange - t.target.lastTotalLoaded;
                    i.debug("onprogress size" + r), r > 0 && (radio("xhrBytesReceived" + this.url).broadcast(this.url, r), t.target.lastTotalLoaded = t.loaded + t.target.startRange, radio("onprogressEvent " + this.url).broadcast(this.url)), i.debug("HTTPDownloader::xhr.onprogress", t.loaded)
                ...
                try {
                    ...
                    i.error("xhr native error" + this.url + o)
                }
                i.debug("after sending xhr start: " + t + " end: " + n)
            }, registerEvents: function () {
                var t = this;
                this.expireRequest = function (n) {
                    t.xhr.lastModified == n && (i.warn("expiring xhr requested on: " + n), e = Math.round(Math.min(i.config.XHR_MAXIMUM_TIMEOUT, 2 * e)), t.stop(), t.xhr.busy = !1, radio("xhrTimeout" + t.url).broadcast(t.xhr))
                }
            }
        })
    }(), function () {
        i.client.MultiSlotManager = Object.subClass({
            name: "peer5.client.MultiSlotManager", ctor: function (e) {
                this.url = e, this.xhrs = [], this.rampup = !0, this.progress = Object.create(null), this.createNewSlot(this.url), this.firstRequest = !0, window.setInterval(this.cron, i.config.XHR_SLOT_PROBE_INTERVAL, this)
                ...
                var t = e.url;
                i.debug("expiring xhr: " + this.url + " " + e.startRange + ":" + e.endRange), this.xhrs[0] && this.xhrs[0].url === t && this.firstRequest && radio("removeResource" + t).broadcast(t, e.status, "First xhr failed"), this.rampup = !1;
                for (var n = 0; n < this.xhrs.length; ++n)if (this.xhrs[n] && this.xhrs[n].url === t) {
        ...
        var e = i.core.dataStructures.PendingBlockMap, t = 2;
        i.client.HTTPController = i.core.controllers.AbstractController.subClass({
            ctor: function () {
                ...
                return this.resourceState[e] && this.resourceState[e] !== t ? !this.xhrs[e].isHTTPBusy() : !1
            }, removeResource: function (e) {
                ...
                if (i.log("initiating HTTPController: " + n), this._super(n), !this.xhrs[n]) {
                    ...
                    radio("xhrFailed" + n).subscribe([function (r) {
                        var s = r.startRange, o = r.endRange;
                        if (!o) {
                            var a = i.core.data.BlockCache.get(n);
                            if (!a)return;
                            o = a.fileSize
                        }
                        for (var c = s / i.config.CHUNK_SIZE, l = Math.ceil((o + 1) / i.config.CHUNK_SIZE) - 1, d = c; l >= d; d++)e.removeChunk(n, d);
                        this.lastFailedStartBlock[n] = s / i.config.BLOCK_SIZE, this.resourceState[n] !== t && radio("HTTPAvailableEvent").broadcast(n)
                    }, this]), this.xhrs[n] = r
                }
            }, download: function (t, n, r) {
                if (this.isAvailable(t)) {
                    ...
                    var h = i.config.BLOCK_SIZE * n, f = i.config.BLOCK_SIZE * (r + 1) - 1;
        ...
        var e = i.core.dataStructures.PendingBlockMap, t = i.core.util.UrlSwarmIdMap, n = 1, r = 2;
        i.client.HybridController = i.core.controllers.AbstractController.subClass({
            ctor: function (e) {
                ...
                radio("P2PAvailableEvent").subscribe([function (e, t) {
                    ...
                    if (n) {
                        var r = n.url, s = n.mod;
                        if (4 === n.mod)return void this.allocateBlocks(r);
                        if (2 !== s && 3 !== s) {
                            var o = null;
                            o = i.config.SEQUENTIAL_DOWNLOAD ? this.relaxedP2PDownload(r, null, null, t) : this.relaxedP2PDownloadRandomly(r, null, null, t), !o || 0 === o.length
                        }
                    }
                    ...
                    if (i.debug("http available"), this.httpController.isAvailable(e)) {
                        ...
                        if (4 === i.state.resources.get(e).mod)return void this.allocateBlocks(e);
                        var n;
                ...
                n ? this.P2PController.removeResource(n) : i.info("not removing p2p resource " + e + " - no swarmId"), this.httpController.removeResource(e), delete this.nonFullResources[e], delete this.resourceState[e]
            }, stopResource: function (e) {
                this.resourceState[e] = r, delete this.nonFullResources[e];
                var n = t.getSwarmId(e);
                ...
                if (this.isAvailable(e)) {
                    ...
                    if (!o.isFull()) {
                        if (n || 0 === n || (n = o.getMissingBlock()), r || 0 === r || (r = o.getNumOfBlocks() - 1), s || (s = i.config.HYBRID_REQUEST_THRESHOLD), s > i.config.HYBRID_REQUEST_THRESHOLD && (this.urgent[e] = !1), n > o.getNumOfBlocks() - 1 || r > o.getNumOfBlocks() - 1)return void i.warn("out of range");
                        var a = n;
                        n = o.getMissingBlock(), n > a && radio("blockReceivedEvent").broadcast(e, i.config.BLOCK_SIZE), (s < i.config.HTTP_REQUEST_THRESHOLD || this.urgent[e] || 3 === i.state.resources.get(e).mod) && (s < i.config.HTTP_REQUEST_THRESHOLD && (this.urgent[e] = !0), i.debug("urgency is: " + s + " downloading from HTTP"), i.config.SEQUENTIAL_DOWNLOAD ? this.aggressiveHTTPDownload(e, n, r) : this.aggressiveHTTPDownloadRandomly(e, n, r)), (i.config.P2P_ALWAYS_DOWNLOAD || s >= i.config.P2P_REQUEST_BEGIN_THRESHOLD && s < i.config.P2P_REQUEST_END_THRESHOLD && this.P2PController.isAvailable(t.getSwarmId(e))) && (i.debug("urgency is: " + s + " downloading from P2P"), i.config.SEQUENTIAL_DOWNLOAD ? this.relaxedP2PDownload(e, n, r) : this.relaxedP2PDownloadRandomly(e, n, r)), (i.config.HTTP_ALWAYS_DOWNLOAD || s >= i.config.HTTP_REQUEST_THRESHOLD && s <= i.config.HYBRID_REQUEST_THRESHOLD && this.httpController.isAvailable(e)) && (i.config.SEQUENTIAL_DOWNLOAD ? this.relaxedHTTPDownload(e, n, r) : this.relaxedHTTPDownloadRandomly(e, n, r))
                    }
                }
            }, blockAllocationCron: function () {
                for (var e = Object.keys(this.nonFullResources), t = 0, r = e.length; r > t; t++) {
                    var s = e[t];
                    if (this.resourceState[s] === n) {
                        var o = i.core.data.BlockCache.get(s);
                        if (o.isFull())delete this.nonFullResources[s]; else {
                            var a = o.getMissingBlock(), c = o.getNumOfBlocks() - 1;
                            this.allocateBlocks(e[t], a, c)
                        }
                    }
                }
            }, dynamicDownload: function (e, t, n, i) {
                this.nonFullResources[e] = i, this.allocateBlocks(e, t, n)
            }, allocateBlocks: function (e, t, n) {
                var r = performance.now(), s = this.nonFullResources[e];
                s && (s - r < i.config.CRITICAL_CONSTRAINT ? (this.aggressiveHTTPDownloadRandomly(e, t, n), i.config.PARALLEL_HTTP_AND_P2P === !0 && this.aggressiveP2PDownloadRandomly(e, t, n)) : this.relaxedP2PDownloadRandomly(e, t, n))
            }, relaxedHTTPDownload: function (n, r, s) {
                var o = i.core.data.BlockCache.get(n);
                r || 0 === r || (r = o.getFirstMissingBlock()), s || 0 === s || (s = o.getNumOfBlocks() - 1);
                ...
                var s = i.core.data.BlockCache.get(t);
                n || 0 === n || (n = s.getFirstMissingBlock()), r || 0 === r || (r = s.getNumOfBlocks() - 1);
                ...
                return c.length > 0 && (r = c[0], s = c[c.length - 1], this.httpController.download(n, r, s)), c.length
                ...
                }), a = i.core.util.longestSequence(o);
                return a.length > 0 && (n = a[0], r = a[a.length - 1], this.httpController.download(t, n, r)), a.length
                ...
                if (this.P2PController.isAvailable(c)) {
                    if (r || 0 === r || (r = a.getFirstMissingBlock()), s || 0 === s || (s = a.getNumOfBlocks() - 1), r > a.getNumOfBlocks() - 1 || s > a.getNumOfBlocks() - 1)return void i.warn("out of range");
                    var l = r;
                ...
                var a = i.core.data.BlockCache.get(n);
                if (!a)return 0;
                r || 0 === r || (r = a.getFirstMissingBlock()), s || 0 === s || (s = a.getNumOfBlocks() - 1);
                ...
                return u
            }, aggressiveP2PDownloadRandomly: function (e, n, r, s) {
                var o = i.core.data.BlockCache.get(e);
                if (!o)return 0;
                n || (n = o.getFirstMissingBlock()), r || (r = o.getNumOfBlocks() - 1);
                var a = t.getSwarmId(e), c = this, l = function (e) {
                    return e >= n && r >= e && !o.has(e) && !c.P2PController.isPendingEntireBlock(a, e)
                }, d = this.P2PController.download(a, s, l);
                return d
            }, init: function (e) {
                var t = i.state.resources.get(e);
                if (!t)return void i.error("HybridController::init:no resource found", e);
                var r = t.mod, s = t.swarmId;
                i.info("initiating resource controllers: url=" + e + " swarmId=" + s + " mod=" + r), this.resourceState[e] = n, this.P2PController.init(s), this.urgent[e] = !1, 2 !== r && this.httpController.init(e), 3 === r && this.P2PController.stopResource(s)
            }, isAvailable: function (e) {
                return (this.P2PController.isAvailable(t.getSwarmId(e)) || this.httpController.isAvailable(e)) && this.resourceState[e] && !(this.resourceState[e] === r)
            }, getConnectionStats: function () {
                return {http: this.httpController.getConnectionStats(), p2p: this.P2PController.getConnectionStats()}
        ...
        function n(t, n) {
            function o(t) {
                ...
                if (n.length > 1)i.warn("Found " + n.length + " " + t + " elements, was expecting only 1"); else if (0 === n.length)return;
                return n[0]
            }

            function a() {
                if (c)for (var e = i.config.VIDEOTAG_BUFFERED_MAX_HOLE, t = c.currentTime, n = r(c), o = s(n, e), a = 0, d = o.length; d > a; a++) {
                    var u = o[a].start, h = o[a].end;
                    if (t + e >= u && h > t)return h - t
                } else if (l)try {
                    return l.getbufferLength()
                } catch (f) {
                }
                return 0
            }

            var c = t || null, l = n || null;
            return t || setInterval(function () {
                c = o("video")
            }, i.config.VIDEOTAG_FIND_INTERVAL), n || setInterval(function () {
                l = o("object")
            }, i.config.VIDEOTAG_FIND_INTERVAL), {getBufferLength: a}
        }

        function r(e) {
            for (var t = e.buffered, n = [], i = 0; i < t.length; i++)n.push({start: t.start(i), end: t.end(i)});
        ...
        function s(e, t) {
            return e.reduce(function (e, n) {
                ...
                return e.push({start: n.start, end: n.end}), e
            }, [])
        }

        t.MediaController = n
    }(document, i.core.media), function () {
        i.core.transport.WsConnection = Object.subClass({
            name: "peer5.core.transport.WsConnection", ctor: function (e, t) {
                ...
                if (this.socketInitiating === !1) {
                    ...
                    var e = this.reconnectionTimeout * Math.pow(2, this.reconnectionAttempts), t = this;
                    setTimeout(function () {
        ...
        i.core.apiValidators.ApiValidatorBase = Object.subClass({
            ...
            detectBrowser: function () {
                var e, t = navigator.appName, n = navigator.userAgent, i = n.match(/(opera|chrome|safari|firefox|msie)\/?\s*(\.?\d+(\.\d+)*)/i);
                return i && null != (e = n.match(/version\/([\.\d]+)/i)) && (i[2] = e[1]), i = i ? [i[1], i[2]] : [t, navigator.appVersion, "-?"]
            },
            getMajorVersionNumber: function (e) {
                var t = e.split("."), n = parseInt(t[0]);
                return n
            },
            validate: function () {
                throw"unimplemented method"
        ...
        var e = window.GoogleAnalyticsObject || "__ga__", t = e;
        Object.defineProperty(window, "GoogleAnalyticsObject", {
            ...
            e.GoogleAnalyticsObject = r, e[r] = e[r] || function () {
                ...
                }, e[r].l = 1 * new Date, s = t.createElement(n), o = t.getElementsByTagName(n)[0], s.async = 1, s.src = i, o.parentNode.insertBefore(s, o)
        }(window, document, "script", "//www.google-analytics.com/analytics.js", t), window[e]("create", "UA-37859248-1", {name: "peer5"}), window[e]("peer5.set", "dimension2", i.config.EXTERNAL_XHR_FALLBACK), window[e]("peer5.send", "pageview"), i.gaManager = function () {
            radio("unhandledError").subscribe([function (t, n, i) {
                window[e]("peer5.send", "event", "unhandled errors", t, n, i)
            }, this]), i.config.DISABLE_GOOGLE_ANALYTICS || (this.registerEvents(), this.downloadStarted = {}, this.fallback = 0)
            ...
            registerEvents: function () {
                ...
                }, this]), radio("downloadFinished").subscribe([function (t, n, i, r, s) {
                    window[e]("peer5.send", "event", "transfer", "downloadFinished", "fileSize", n), window[e]("peer5.send", "event", "transfer", "downloadFinished", "p2p bytes downloaded", i), window[e]("peer5.send", "event", "transfer", "downloadFinished", "http bytes downloaded", r), window[e]("peer5.send", "event", "transfer", "downloadFinished", "filesystem bytes resumed", s)
        ...
        function e(e, n) {
            if (e in t) {
                ...
                for (var s in r)if (r[s].required && typeof n[s] !== r[s].type)return !1;
                return !0
            }
            return !1
        }
        ...
        var t = {
            player: {
                ...
                timeSinceLoaded: {type: "number", required: !1},
                duration: {type: "number", required: !1},
                vendor: {type: "string", required: !0},
                id: {type: "string", required: !0},
                occurrence: {type: "number", required: !1},
                timeSinceReady: {type: "number", required: !1}
            }, playback: {currentSegment: {type: "string", required: !0}}
        };
        ...
        i.core.data.FSioFireFox = Object.subClass({
            ctor: function (e) {
                ...
                var t = this, n = window.indexedDB.open(i.config.FS_ROOT_DIR, {version: 4, storage: "temporary"});
                ...
                var t = this, n = window.indexedDB.open(i.config.FS_ROOT_DIR, {version: 4, storage: "persistent"});
                n.onerror = function (n) {
                    t.errorHandler(n), console.log(n), e && e(!1)
                }, n.onupgradeneeded = function (e) {
                    e.target.result.createObjectStore(t.filesObjectStore)
                ...
                a.onsuccess = function (n) {
                    ...
                    o.onsuccess = function (n) {
                        r.filesMetaData[e] = {fileLength: n.target.result.size, appendedSinceLastFlush: 0}, t && t(!0)
                    }, o.onerror = function (e) {
                        r.errorHandler(e), t && t(!1)
                    }
                }, a.onerror = function (e) {
        ...
        function t() {
            function e(e) {
                ...
                return e - t < i.config.CRITICAL_CONSTRAINT ? n : 0 === i.clientInstance.controller.getNumberOfConnectedPeers() ? n : r
            }

            return {chooseMethod: e}
        }

        var n = "download", r = "head";
        e.initDecider = t()
    }(i.client), function (e) {
        function t(e, t, n) {
            function r(e, t) {
            ...
            function o() {
                radio("xhrSent" + e).unsubscribe(o), radio("xhrSent").broadcast(e)
            }
            ...
            function c(n) {
                i.core.dataStructures.PendingBlockMap.removeResource(e), i.info("received bytes " + e), radio("bytesReceivedEvent" + e).unsubscribe(c), radio("stopHttpInit" + e).unsubscribe(l), radio("xhrBytesReceived" + e).unsubscribe(r), radio("bytesReceivedEvent").broadcast(n), radio("xhrLoadEnd").unsubscribe(a), g.stop(), t && (t.preventDownload = !1)
            }

            function l() {
                i.info("stopping httpDownloader init " + e), g && g.stop(), f && radio("responseHeadersReceived" + e).unsubscribe(f), c && radio("bytesReceivedEvent" + e).unsubscribe(c), r && radio("xhrBytesReceived" + e).unsubscribe(r), a && radio("xhrLoadEnd").unsubscribe(a), t && delete t.preventDownload
            }

            function d(t) {
                var r = new i.core.protocol.FileInfo(t.md5, t.length, t.md5, null, i.config.BLOCK_SIZE, e);
                n(r), t.length > i.config.SMALL_FILE_SIZE && g.stop()
            }

            function u(o, l) {
                "GET" === l && (i.core.dataStructures.PendingBlockMap.addResource(e, o.length), (4 !== t.mod || i.config.PARALLEL_HTTP_AND_P2P === !1) && (t.preventDownload = !0), radio("bytesReceivedEvent" + e).subscribe(c), radio("xhrBytesReceived" + e).subscribe(r), radio("onprogressEvent " + e).subscribe(s), radio("xhrLoadend" + e).subscribe(a), i.feature.isEnabledAndInitialized(i.config.FEATURE_PROXY_HEAD_KEY) && (g = new i.client.HTTPDownloader(e), g.download()));
                var d = i.core.util.urlDigest.swarmId(e), u = i.core.util.MD5.hash(o.length + d + i.config.A_B_CONFIG_JSON);
                i.core.util.UrlSwarmIdMap.addMapping(e, u), i.info("SwarmId for url: " + e + " is: " + u), t.hashUrl = i.core.util.MD5.hash(d);
                var h = new i.core.protocol.FileInfo(u, o.length, null, null, i.config.BLOCK_SIZE, e);
                n(h)
            }

            function h(r) {
                g.stop(), g = new i.client.HTTPDownloader(e), radio("bytesReceivedEvent" + e).subscribe(function s(o) {
                    i.info("received bytes " + e), radio("bytesReceivedEvent" + e).unsubscribe(s), radio("stopHttpInit" + e).unsubscribe(l);
                    var a = new i.core.util.MD5.ArrayBuffer;
                    a.append(o.dataArray), a.append(new Uint8Array(r.length.toString().split(""))), a.append(new Uint8Array(i.config.A_B_CONFIG_JSON.split("")));
                    var c = a.end();
                    i.info("SwarmId for url: " + e + " is: " + c), t.hashUrl = i.core.util.MD5.hash(e);
                    var d = new i.core.protocol.FileInfo(c, r.length, null, null, i.config.BLOCK_SIZE, e);
                    n(d)
                }), g.download(0, i.config.CHUNKY_HEAD_LENGTH)
            }

            function f(n, r) {
                var s = i.core.util.parseResponseHeaders(n);
                radio("HTTPHeadersReceived" + e).broadcast(e, n, s);
                var o = Object.create(null);
                s["content-md5"] && (o.md5 = s["content-md5"]);
                var a = i.core.util.parseResponseLengthHeader(s["content-range"], s["content-length"]);
                return a && (o.length = a), t.state >= 1 && i.warn("receiveMeta but resource is already initiated"), i.info("subscribing stopHttpInit " + e), radio("stopHttpInit" + e).subscribe(l), radio("responseHeadersReceived" + e).unsubscribe(f), radio("xhrFailed" + e).unsubscribe(p), radio("xhrTimeout" + e).unsubscribe(p), o.length ? !i.config.USE_FS && o.length > i.config.ALLOWED_FILE_SIZE ? void radio("removeResource").broadcast(e, i.Request.FILE_SIZE_ERR, "file size too big") : o.md5 ? void d(o) : o.length <= i.config.SMALL_FILE_SIZE ? void u(o, r) : void h(o, r) : (i.error("no Content-Length in headers for file: " + e), radio("removeResource").broadcast(e, i.Request.FILE_SIZE_ERR, "file size undefined"), void i.feature.disable(i.config.FEATURE_PEER5_REQUEST_KEY))
            }

            function p(t) {
                radio("xhrFailed" + e).unsubscribe(p), radio("xhrTimeout" + e).unsubscribe(p), radio("responseHeadersReceived" + e).unsubscribe(f), radio("xhrSent" + e).unsubscribe(o);
                var n = t.status, i = "xhr failed or timed out";
                radio("removeResource").broadcast(e, n, i)
            }

            var g = new i.client.HTTPDownloader(e);
            if (radio("xhrFailed" + e).subscribe(p), radio("xhrTimeout" + e).subscribe(p), radio("responseHeadersReceived" + e).subscribe(f), radio("xhrSent" + e).subscribe(o), i.feature.isEnabledAndInitialized(i.config.FEATURE_PROXY_HEAD_KEY))g.head(); else if (4 === t.mod) {
                var m = i.client.initDecider.chooseMethod(t.constraint);
                g[m]()
            } else 2 === t.mod ? g.head() : g.download()
        }
        ...
        function t() {
            function e(e, t) {
                var n = Object.create(null);
                n.value = t, n.keys = [e], s[e] = n, o[e] = e
            }

            function t(e, t) {
                return o[t] !== t ? void i.warn("cant alias a non existing key") : (o[e] = t, void s[t].keys.push(e))
            }
            ...
            function r(e) {
                var t = o[e], n = s[t].keys;
                n.forEach(function (e) {
                    delete o[e]
                }), delete s[t]
            }

            var s = Object.create(null), o = Object.create(null);
            return {add: e, get: n, alias: t, remove: r}
        }
    ...
    i.state = {}, function (e) {
        function t() {
            function e(e) {
                ...
                var n = t.url;
                return n && (s.add(n, t), t.swarmId && s.alias(swarmId, n)), t
            }
            ...
            var s = i.core.dataStructures.MultiKeyMap();
            return {add: e, get: t, remove: n, alias: r}
        }
        ...
        i.client.DownloadUploadManager = Object.subClass({
            ...
            ctor: function () {
                if (this.clientId = i.core.util.generate_uuid(), this.registerEvents(), this.apiValidator = new i.core.apiValidators.ApiValidator({
                    ...
                    this.wsConnectionImpl = new i.core.transport.WsConnection(e, this.clientId), this.controller = new i.client.HybridController(this.clientId), this.queuedResource = Object.create(null), this.lastReportTime = Date.now(), this.lastStatCalcTime = 0, this.cron_interval_id = window.setInterval(this.cron, i.config.MONITOR_INTERVAL, this), radio("peer5_uuid").broadcast(this.clientId)
            ...
            addResource: function (e, t, n, r) {
                radio("resourceAdded").broadcast(e);
                var s = i.state.resources.get(e);
                if (i.info("Adding resource " + e + " with state: " + (s ? s.state : "null")), s && s.state >= 0) {
                    if (s.state < 4)return i.info("Queuing add resource that is already in progress"), void(this.queuedResource[e] = {args: arguments});
                    3 == s.mod && 2 == t && i.info(e + " was prefetched in http and then p2p"), s.mod = t, s.constraint = r;
                    var o = i.core.data.BlockCache.get(e);
                    if (o)var a = o.getMetadata();
                    return a ? (this.controller.init(e), radio("fileInfoProcessed").broadcast(a), void radio("resourceReady" + e).broadcast(a)) : void i.error("couldn't add resource already exists in unstable state")
                }
                if (i.state.resources.add({
                    ...
                    var c = e.slice(8);
                    i.state.resources.alias(c, e), this.leechSwarm(c)
                }
            },
            removeResource: function (e) {
                var t = i.state.resources.get(e);
            ...
            readBlobData: function (e, t) {
                ...
                i.core.data.BlockCache.add(e, new i.core.dataStructures.BlockMap(r, e, n.md5, n.sha1));
                var s = this, o = i.core.data.BlockCache.get(e);
                i.config.USE_FS && o.fs ? radio("filesystemInitiated" + e).subscribe([function () {
                    1 == o.fs && i.config.PREALLOCATE_FILE ? o.allocateFileSizeSync(function (n) {
            ...
            getLoadedStats: function (e, t) {
                var n = i.core.stats.StatsCollector.getStats(e), r = Object.create(null);
            ...
            getCompatibilityStatus: function (e) {
                var t = this.apiValidator.getStatus(), n = this.apiValidator.getBrowser();
                e(t, n)
            },
            _initiateHttpResource: function (e) {
                ...
                var t = i.state.resources.get(e);
                if (t.hash && t.length) {
                    var n = new i.core.protocol.FileInfo(t.hash, t.length, t.hash, null, i.config.BLOCK_SIZE, e);
                    this.joinSwarm(n.swarmId), this.handleFileInfo(n)
                } else {
                    var r = function (e) {
                        this.joinSwarm(e.swarmId), this.handleFileInfo(e)
                    }.bind(this);
                    i.client.getHttpMeta(e, t, r)
                }
            },
            createAndUploadFileInfo: function (e) {
                var n = i.state.resources.get(e), r = n.hashAlg.end();
                t.addMapping(e, r), n.hash = r, this.changeResourceId(e, n.hash);
                var s = i.core.data.BlockCache.get(e), o = new i.core.protocol.Share(n.hash, s.fileSize, n.hash, n.blockHashes, i.config.BLOCK_SIZE);
                return this.wsConnectionImpl.sendMessage(o), o
            },
            readBlobInSlices: function (e, t) {
                if (!i.core.data.BlockCache.get(e).fs && t.size > i.config.ALLOWED_FILE_SIZE)return void radio("removeResource").broadcast(e, i.Request.FILE_SIZE_ERR, "file size too big");
                var n = this;
                i.core.util.fileHandler.readFileInSlices(e, t, i.config.BLOCK_SIZE, function (e, t, r) {
                    e && t && r ? (i.log("adding chunks"), n.addChunks(e, t, r)) : (!e || t || r) && i.error("handle error")
                })
            },
            addChunks: function (e, t, n) {
                ...
                r.hashAlg.append(t);
                for (var s = i.core.data.BlockCache.get(e), o = Math.ceil(t.byteLength / i.config.CHUNK_SIZE), a = 0; o > a; a++) {
                    var c = a * i.config.CHUNK_SIZE, l = new Uint8Array(t.slice(c, Math.min(c + i.config.CHUNK_SIZE, t.byteLength))), d = s.setChunk(r.chunkRead, l), u = s.ingestBlock(d);
                    u && (r.blockHashes[d] = u), radio("chunkAddedToBlockMap").broadcast(), r.chunkRead++
                }
                r.chunkRead == this.numOfChunksInFile && (this.hasEntireFile = !0), s.fs ? i.core.data.FSio.notifyFinishWrite(n) : n()
            },
            cron: function (e) {
                e.sendReportPeriodically(), e.calculateStats(), radio("cron").broadcast();
                for (var t in i.core.data.BlockCache._blockMaps) {
                    var n = i.state.resources.get(t);
                    n && 2 !== n.mod && i.core.data.BlockCache.get(t) && !i.core.data.BlockCache.get(t).isFull() && (0 === i.core.stats.StatsCollector.statsCalculators[t].Avg_Recv_HTTP ? n.httpIdle++ : n.httpIdle = 0, n.httpIdle >= i.config.HTTP_IDLE_RESET_DURATION / i.config.MONITOR_INTERVAL && (e.controller.stopHttp(i.core.data.BlockCache.get(t).getMetadata().url), n.httpIdle = 0), e.controller.downloadPeriodicTest(i.core.data.BlockCache.get(t).getMetadata().url))
                }
            },
            ...
            handleFileInfo: function (e) {
                ...
                var s = i.state.resources.get(r), o = new i.core.dataStructures.BlockMap(e.size, n, s.md5, s.sha1);
                i.core.data.BlockCache.add(n, o), o.addMetadata(e), this.changeResourceId(r, n), s.state = 1, s.swarmId = n, radio("fileInfoProcessed").broadcast(e), o.fs || radio("resourceInit").broadcast(e)
            },
            updateFileInfo: function (e) {
                var t = e.url, n = e.swarmId, r = i.state.resources.get(t);
                this.changeResourceId(t, n, function (t) {
                    if (t) {
                        r.state = 1, r.swarmId = n;
                        var s = i.core.data.BlockCache.get(n);
                        s.addMetadata(e), radio("resourceInit").broadcast(e)
            ...
            registerEvents: function () {
                radio("pauseResource").subscribe([function (e, t, n) {
                    this.stopResource(e), radio("resumeResource").subscribe([function (t) {
                        if (t === e) {
                            var n = null;
                            i.state.resources.get(e);
                            resource.md5 ? n = {md5: resource.md5} : resource.sha1 && (n = {sha1: resource.sha1}), this.addResource(e, resource.mod, n)
                        }
                    }, this])
                }, this]), radio("stopResource").subscribe([function (e, t, n) {
                    var r = i.state.resources.get(e), s = r ? r.mod : null;
                    radio("requestError" + e).broadcast(t, n), radio("resourceLoadEnd").broadcast(e, s), this.stopResource(e)
                    ...
                    var o = i.state.resources.get(e);
                    if (!o.preventDownload) {
                        var a = i.core.data.BlockCache.get(e), c = t ? a.getBlockIndex(t) : null, l = n ? a.getBlockIndex(n) : null;
                        s && i.warn("We don't support in pausing and resuming"), 4 === o.mod ? this.controller.dynamicDownload(e, c, l, r) : this.controller.download(e, c, l, r)
                    }
                    ...
                    var t, n = i.state.resources.get(e.swarmId);
                    switch (e.error) {
                        case i.core.protocol.SWARM_NOT_FOUND:
                            if (!n)return void i.warn("swarm not found for an unexisting resource");
                            if (1 == n.mod || 3 == n.mod)return;
                            if (void 0 !== n.hashUrl)return;
                            if (2 == n.mod) {
            ...
            ctor: function (e) {
                ...
                i.clientInstance.isValidated(function (n) {
                    ...
                    if (!e && t._get && 1 == t.readyState) {
                        ...
                        t.sha1 ? r.sha1 = t.sha1 : t.md5 && (r.md5 = t.md5), t._startLoaded = i.core.stats.StatsCollector.getStats(t._url).totalVerifiedBytes || 0, t._startTime = Date.now(), i.clientInstance.addResource(t._url, t.downloadMode, r, t._constraint)
                    }
        ...
        var t = function () {
            ...
            function s(e, i) {
                ...
                var d = t(e, i), u = n(i), h = o(i) ? "live" : "vod", f = {segments: d, durations: u, mode: h}, p = {};
                return p[e] = f, p
            }
        ...
        e.PlaylistsHandler = function () {
            ...
            function t(e, t) {
                if (!t)return [];
                void 0 !== m[e] ? m[e].addSegments(t) : m[e] = i.core.playlist.Playlist(t);
            ...
            function n(e) {
                v.segment = e, v.timeStamp = Date.now()
            }
            ...
            function a(e) {
                if (!E)return null;
                var t = _[E], n = m[t], i = n.getIndex(e);
                if (-1 === i)return null;
                var r = n.getIndex(E);
                return i - r
            }
            ...
            function c(e) {
                if (!E || 0 >= e)return [];
                var t = _[E], n = m[t], i = n.getSegmentsInterval(E, e);
                return i
            }

            function l(e) {
                if (!E || 0 >= e)return null;
                var t = _[E], n = m[t], i = n.getSegmentsDataInterval(E, e);
            ...
            function d() {
                if (!E)return !1;
                var e = _[E], t = m[e], n = t.getIndex(E);
                return n > -1
            }
            ...
            function h() {
                for (var e in m)if ("live" === m[e].getMode())return !0;
                return !1
            }

            function f(e) {
                var t = _[e], n = m[t], i = n.getSegmentData(e);
            ...
            function p() {
                ...
                if (!e)return null;
                var t = f(e);
                if ("live" !== m[t.segmentData.playlistName].getMode())return null;
                var n = (Date.now() - v.timeStamp) / 1e3;
                n = Math.min(n, t.segmentData.duration);
                for (var i = t.segmentData.duration - n, r = _[e], s = m[r], o = s.getSegments(), a = o.indexOf(e), c = 0, l = a + 1; l < o.length; l++) {
                    var d = o[l], u = f(d);
            ...
            function g(e) {
                if (!E)return 0;
                for (var t = _[e], n = m[t], i = n.getIndex(E), r = n.getIndex(e), s = n.getSegments(), o = 0, a = i; r > a; a++) {
                    var c = f(s[a]);
                    o += c.segmentData.duration
                }
                return o
            }

            var m = Object.create(null), _ = Object.create(null), E = null, v = {segment: null, timeStamp: null};
            return radio("external.playback").subscribe(function (e) {
                ...
                hasLivePlaylist: h,
                getSegmentData: f,
                getDurationFromLastRequestToSegment: g
            }
        }
    }(i.core.playlist),function (e) {
        var t = function (e) {
        ...
        function t() {
            ...
            function n(e, n) {
                ...
                i.open("GET", e._url), i.responseType = e.responseType, i.onloadstart = t(e.onloadstart, e), i.onprogress = t(e.onprogress, e), i.onabort = t(e.onabort, e), i.onerror = t(e.onerror, e), i.onload = t(e.onload, e), i.ontimeout = t(e.ontimeout, e), i.onloadend = t(e.onloadend, e), i.addEventListener("readystatechange", function (t) {
                    ...
                    e.setResponseHeaders(s)
                }), i.onreadystatechange = e.onreadystatechange ? e.onreadystatechange.bind(i) : null;
                for (var s in e.eventListeners)for (var o = 0; o < e.eventListeners[s].length; o++)i.addEventListener(s, t(e.eventListeners[s][o], e));
                return i
            }
        ...
        function t() {
            ...
            var r = Object.create(null);
            return {save: e, load: t, remove: n, clear: i}
        }
        ...
        function t(e, t) {
            ...
            function r() {
                var e = new i.Request({downloadMode: o.downloadMode || "p2p"}), t = o.segment;
                return e._segmentData = o, e.mediaPrefetch = !0, e.responseType = "blob", e.open("GET", t), e.onswarmstatechange = function (e) {
        ...
        function t(e, t) {
            ...
            function a(e) {
                ...
                t.open("GET", e), t.onload = function () {
                    var t = i.core.util.PlaylistParserFactory.getParser(e), n = t.extractPlaylistsData(e, this.response), r = Object.keys(n), s = n[r[0]];
                    if (s) {
                        b.extractSegments(e, this.response), s.rawContent = this.response, s.manifestUrl = e;
                        var o = t.isLiveMod(this.response);
                        o ? h(s) : (w.save(e, this.response), p(s))
                    } else w.save(e, this.response), a(r[0])
                }, t.send()
            }

            function c() {
                var e = i.core.util.ManifestManipulator(E.rawContent), t = e.delayManifest(i.config.LIVE_SECONDS_DELAY);
                w.save(E.manifestUrl, t);
                var n = i.core.util.PlaylistParserFactory.getParser(E.manifestUrl), r = n.extractPlaylistsData(E.manifestUrl, t), s = Object.keys(r), o = r[s[0]];
                return o
            }
            ...
            function d() {
                ...
                for (var n = E.segments.indexOf(t), i = 0, r = n; r < E.segments.length; r++) {
                    var s = T.getAvgDownloadTime(E.manifestUrl), o = E.durations[r], a = o * s;
                    if (i >= a)break;
                    i += o
                }
                return r
            ...
            function u() {
                if (!A) {
                    ...
                    if (e)for (var n = g(e), i = S.availableP2PSlots(); t < E.segments.length && i > 0; t++) {
            ...
            function f(e) {
                if (!A)for (var t = S.availableP2PSlots(); t > 0 && e.length > 0;) {
                    var n = e.shift();
                    o(n, function () {
                        f(e)
                    }), t--
            ...
            var E, v = t, b = e.playlistsHandler, S = e.prefetchSlotsHandler, T = e.prefetchSpeedEstimator, R = Object.create(null), w = e.playlistsCache, A = !1;
            return {startPrefetch: m, stopPrefetch: _}
        }
        ...
        function t(e) {
            ...
            function d() {
                if (i.config.FEATURE_LIMIT_SLOTS_BY_PEERS) {
                    var e = g(), t = E();
                    t > e && (R.availableP2PSlots++, b = !1, c(), o())
                } else R.availableP2PSlots++, b = !1, c(), o()
            }
            ...
            var E = e, v = 0, b = !1, S = 0, T = 0, R = {availableP2PSlots: i.config.INITIAL_P2P_SLOTS};
            return function () {
                radio("activePeerConnectionsNumberChanged").subscribe([h, this])
            }(), {availableP2PSlots: m, useP2PSlot: f, askForP2PSlot: _, reportRequestDone: l}
        }
        ...
        function t(e, t) {
            function o(e) {
                ...
                var t = {
                    onswarmstatechange: function (e) {
                        ...
                        radio("p2pAbort").broadcast(e.currentTarget.fileInfo.swarmId), _.reportRequestDone(s), g.onP2PPrefetchComplete(), E.onRequestEvent("abort", e)
                    }, onload: function (e) {
            ...
            function a() {
                ...
                var e = b.segmentData.duration, t = (Date.now() - b.segmentData.playerAskTime) / 1e3, n = e - t;
                return n
            }
            ...
            function d(e, t) {
                ...
                var n = e.segmentData.duration, i = e.segmentData.playlistName, r = E.getAvgDownloadTime(i), s = r * n;
            ...
            function h() {
                ...
                var t = e.segmentsData, n = _.availableP2PSlots();
                c(n, t);
            ...
            var g = t, m = e.playlistsHandler, _ = e.prefetchSlotsHandler, E = e.prefetchSpeedEstimator, v = Object.create(null), b = null, S = Object.create(null), T = !0;
        ...
        i.core.apis.MediaFetcher = Object.subClass({
            ctor: function () {
                ...
                if (!e.mediaPrefetch)if (this.interceptRequests[e._url])this._interceptSegmentRequest(e); else if (!this.interceptRequests[e._url] && i.core.util.PlaylistParserFactory.isPlaylistCandidate(e))this.prePlaySegmentsPrefetcher.stopPrefetch(), this.playerStarted = !0, this._interceptPlaylistRequest(e); else if (i.config.INTERCEPT_AES && -1 !== e._url.indexOf("aes")) {
                    var t = i.core.util.requestToXhr.create(e);
                    t.send(), e._get = !1
                } else i.warn("didnt intercept: " + e._url)
            }, _interceptPlaylistRequest: function (e) {
                i.info("Intercepted a playlist request"), e._get = !1;
                var t = this.playlistsCache.load(e._url);
                if (t)return void i.core.util.envokeCallback(function () {
                    var n = this;
                    setTimeout(function () {
                        n.playlistsCache.remove(e._url)
                    }, 1e3), e.addEventListener("load", this._measurePlaylistSpeed.bind(this)), e.addEventListener("load", this._parsePlaylist.bind(this)), e.forceImmediateLoad(t)
                }, null, this);
                e.addEventListener("load", this._cachePlaylist.bind(this));
                var n = i.client.createManifestRequest(e);
                if (n.addEventListener("load", this._parsePlaylist.bind(this)), n.addEventListener("load", this._measurePlaylistSpeed.bind(this)), i.config.PLAYLIST_SPEED_ESTIMATION && 0 === this.downloadSpeed[0] && n.addEventListener("progress", this._playlistRequestProgress.bind(this)), n.send(), i.config.PLAYLIST_TIMEOUT) {
                    var r = i.config.PLAYLIST_TIMEOUT_DURATION;
                    setTimeout(function () {
                        n.readyState < 4 && (i.info("playlist request timedout " + n._url), n.abort())
                    }.bind(this), r)
                }
                ...
                i.config.FEATURE_P2P_IMPROVEMENT_ENABLED ? this.segmentsPrefetcher.updatePlayerLastRequestedSegment(e._url) : this.playlistsHandler.setLastRequestedSegment(e._url), this._requestExist(e._url) ? this._updateRequest(e, e._url) : this._addRequest(e, e._url), this._overrideInterceptedRequest(e), e.addEventListener("load", this._requestLoaded.bind(this)), e.addEventListener("swarmstatechange", this._requestSwarmStateChanged.bind(this))
            }, _changeNumOfPeers: function (e) {
                this.numOfPeers = e, this.reportProgress({type: "swarmChange", peers: e})
                ...
                if (i.config.PLAYLIST_SPEED_ESTIMATION && 0 === this.downloadSpeed[0]) {
                    var t = performance.now() - e.currentTarget.startTime, n = 1e3 * e.total / t;
                    radio("playlistSpeedEstimation").broadcast(n)
                }
            }, _requestLoaded: function (e) {
                i.info("request " + e.currentTarget._url + " loaded"), 2 === e.currentTarget.downloadMode ? this._decreaseP2PPendingRequests() : 3 === e.currentTarget.downloadMode || 1 === e.currentTarget.downloadMode ? this._decreaseHTTPPendingRequests() : 4 === e.currentTarget.downloadMode || i.error("unidentified downloadMode request loaded" + e.currentTarget.downloadMode), this.reportProgress({
                    type: "fileDownloaded",
                    url: e.currentTarget._url,
                    loaded: e.loaded,
                    p2p: e.loadedP2P,
                    ...
                    fileSize: e.total,
                    downloadTimeMS: Date.now() - e.currentTarget.timestamp
                }), 200 == e.currentTarget.status && (this.playlistsHandler.deleteToSegment(e.currentTarget._url), this._saveDownloadSpeed(e.currentTarget), setTimeout(function () {
                    this._prefetch("http"), this._prefetch("p2p")
                }.bind(this), 10))
            }, _requestSwarmStateChanged: function (e) {
                if (e.sent) {
                    var t = {type: "swarmChange", sent: e.sent};
                    this.reportProgress(t)
                }
            }, _prefetch: function (e) {
                if (this.playerStarted && 0 !== this.numOfPeers)if (this.playlistsHandler.lastRequestedSegmentExists() || i.warn("last id player requested is not found"), i.config.FEATURE_P2P_IMPROVEMENT_ENABLED)for (var t = this.segmentsPrefetcher.prefetchSegments(), n = 0; n < t.length; n++) {
                    var r = t[n];
                    this._addRequest(r.xhr, r.url)
                } else if ("http" === e) {
                    if (this.httpPendingRequests >= i.config.MAX_HTTP_REQUESTS)return;
                    for (var s = [], o = this.playlistsHandler.getNextSegmentsWindow(i.config.HTTP_VOD_WINDOW), n = 0; n < o.length; n++) {
                        var a = o[n];
                        if (!this._requestExist(a)) {
                            var c = i.core.util.urlDigest.getNormalizedUrlHash(a), l = Object.keys(this.segmentsInfo[c]).length;
                            0 === l && s.push(a)
                        }
                    }
                    var a = s[Math.floor(Math.random() * s.length)];
                    if (!a)return void this._prefetch("p2p");
                    i.info("prefetching " + a + " in http"), this._requestP5(a, null, {downloadMode: "http"}), this._prefetch("http")
                } else if ("p2p" === e) {
                    if (this.p2pPendingRequests >= i.config.MAX_P2P_REQUESTS)return;
                    for (var s = [], d = 1, o = this.playlistsHandler.getNextSegmentsWindow(i.config.P2P_VOD_WINDOW), n = 0; n < o.length; n++) {
                        var a = o[n];
                        if (!this._requestExist(a)) {
                            var c = i.core.util.urlDigest.getNormalizedUrlHash(a), u = this.segmentsInfo[c];
                            if (u) {
                                var l = Object.keys(u).length;
                                l === d ? s.push(a) : l > d && (s = [a], d = l)
                            }
                        }
                    }
                    var a = s[Math.floor(Math.random() * s.length)];
                    if (!a)return;
                    i.info("prefetching " + a + " in p2p"), this._requestP5(a, null, {downloadMode: "p2p"}), this._prefetch("p2p")
                }
            }, _requestP5: function (e, t, n) {
                var r = new i.Request({downloadMode: n.downloadMode});
                r.mediaPrefetch = !0, r.responseType = "blob", r.open("GET", e);
                var s = this;
                r.onswarmstatechange = this._requestSwarmStateChanged.bind(this), r.onerror = function (t) {
                    n.downloadMode && "p2p" === n.downloadMode ? s._decreaseP2PPendingRequests() : s._decreaseHTTPPendingRequests(), i.info("onerror prefetching resource: " + e), s._scavange(e, r), s._prefetch(n.downloadMode || "http")
                }, r.onabort = function (e) {
                    n.downloadMode && "p2p" === n.downloadMode ? (radio("p2pAbort").broadcast(e.currentTarget.fileInfo.swarmId), s._decreaseP2PPendingRequests()) : s._decreaseHTTPPendingRequests(), s._prefetch(n.downloadMode || "http")
                }, r.onload = function (t) {
                    i.info(t), i.info("onload " + e), s.reportProgress({
                        type: "fileDownloaded",
                        url: e,
                        loaded: t.loaded,
                        p2p: t.loadedP2P,
                    ...
                    }), n.downloadMode && "p2p" === n.downloadMode ? s._decreaseP2PPendingRequests() : s._decreaseHTTPPendingRequests(), 200 === this.status && (s._saveDownloadSpeed(this), s._prefetch(n.downloadMode || "http"))
                }, i.info("requesting " + e), n.downloadMode && "p2p" === n.downloadMode ? (this._increaseP2PPendingRequests(), i.info("request:p2pPendingRequests = " + this.p2pPendingRequests + " , " + e)) : this._increaseHTTPPendingRequests(), this._addRequest(r, e), r.send()
                ...
                var n = this.requests[t];
                n.readyState < 4 && (i.info("aborting a prefetched request:" + t), n.abort(), this.reportProgress({
                    type: "requestAborted",
                    mode: 2 === n.downloadMode ? "p2p" : "http"
                }), this._saveDownloadSpeed(n)), this.requests[t] = e, this.requestLRU.update(t, e)
            }, _scavange: function (e, t) {
                if (i.info("removing request" + e), !t)return void i.warn("scavanging an undefined request");
                var n = t.getFileInfo();
                n ? (t.abort({leaveSwarm: !0}), t.readyState >= 2 && (this.totalRequestSize -= n.size)) : i.warn("scavanged a request that hadnt initiated" + e), delete this.requests[e]
                ...
                var t = e.currentTarget._url, n = e.currentTarget.response;
                ...
                var r = this.playlistsHandler.extractSegments(t, n);
                if (r && 0 !== r.length) {
                    for (var s = 0; s < r.length; s++) {
                        var o = r[s], a = i.core.util.urlDigest.getNormalizedUrlHash(o);
                        this.segmentsInfo[a] || (this.segmentsInfo[a] = Object.create(null)), this.interceptRequests[o] = !0
                    }
                    i.info(this.segmentsInfo)
                }
            }, _overrideInterceptedRequest: function (e) {
                var t, n = i.core.util.urlDigest.getNormalizedUrlHash(e._url), r = Object.keys(this.segmentsInfo[n]).length;
                0 === r ? t = 0 : r >= 1 && (t = this.downloadSpeed[1]);
                var s;
                if (i.config.AGGRESSIVE_P2P && t > this.downloadSpeed[0])i.info("override interception to p2p"),
                    e.downloadMode = 2, s = i.config.P2P_TIMEOUT_DURATION, this._increaseP2PPendingRequests(); else if (i.config.SYNCED_BUFFERS) {
                    i.info("override interception to dynamic mode"), e.downloadMode = 4;
                    var o = this.mediaController.getBufferLength(), a = this.playlistsHandler.getDurationFromLastRequestToSegment(e._url);
                    e._constraint = performance.now() + 1e3 * (o + a), s = Math.min(i.config.HTTP_TIMEOUT_DURATION, i.config.P2P_TIMEOUT_DURATION)
                } else i.info("override interception to http"), e.downloadMode = 3, s = i.config.HTTP_TIMEOUT_DURATION, this._increaseHTTPPendingRequests();
                i.config.REQUEST_TIMEOUT && setTimeout(function () {
                    e.readyState < 4 && (i.info("intercepted request timedout " + e._url), e.abort(), 2 === e.downloadMode ? this._decreaseP2PPendingRequests() : this._decreaseHTTPPendingRequests(), this._saveDownloadSpeed(e))
                }.bind(this), s)
            }, _saveDownloadSpeed: function (e) {
                var t = e._speed;
                if (t) {
                    if (2 === e.downloadMode)var n = i.core.util.urlDigest.getNormalizedUrlHash(e._url), r = (Object.keys(this.segmentsInfo[n]).length, 1); else var r = 0;
                ...
                this.httpPendingRequests--, this.httpPendingRequests < 0 && i.error("p2pPendingRequests smaller than 0")
        ...
        if (e && e.config.PIXEL_SWARM) {
            var n = window.location.href, i = t(n), r = new e.core.protocol.Join(i);
        ...
        i.core.data.CacheManager = Object.subClass({
            ctor: function () {
            ...
            }, fillLibraryWithMultipleFiles: function (e, t, n, r, s) {
                var o = this, a = this.getRandomArbitrary(n, r);
                if (console.log(a), e == t)s(!0); else {
                    var c = Date.now();
                    i.core.data.FSio.createResource(c, function (l) {
                        console.log("started to write file with id " + c), i.core.data.FSio.write(c, new Uint8Array([]), a, function (i, l) {
                            i ? (console.log("wrote file with id " + c), o.fillLibraryWithMultipleFiles(e + 1, t, n, r, s)) : "space" === l && o.handleOutOfSpace(c, a, function () {
                                console.log("handleOutOfSpace")
                            })
                        })
                    }, !0)
                }
            }, performHandleOuOfSpaceMainFunction: function (e, t, n, r, s, o, a) {
                var c = e;
                i.core.data.FSio.getLibraryStatistics(function (e) {
                    s = e;
                    var l = c.getFileSizeFromArray(t, s.filesStats), d = c.sumFilesSizeExcludingCurrent(t, s.filesStats), u = 0, h = [], f = 0;
                    if (n > (l + d + a) / o)c.failedToCleanUpOutOfSpace(t, s, r); else {
                        for (c.sortArrayOfFilesObjectByLastModified(s.filesStats); (o * n - l - a > u || (d - l - a) / 2 + n > u) && f < s.filesStats.length;)if (-1 == s.filesStats[f].key.toString().indexOf(".fi"))if (t != s.filesStats[f].key && c.isSafeToDeleteFile(s.filesStats[f])) {
                            h.push(s.filesStats[f]);
                            var p = c.findCorrespondingFileInfo(s.filesStats, s.filesStats[f].key + ".fi");
                            p && h.push(p), u += s.filesStats[f].size, f++
                        } else f++; else f++;
                        u >= o * n - l - a ? i.core.data.FSio.deleteFiles(h, i.core.data.FSio, function (e) {
                            e ? r && r(!0) : (i.error("deleteFiles failed for an unknown reason"), r && r(!1))
                        }) : c.failedToCleanUpOutOfSpace(t, s, r)
                    }
                })
            }, handleOutOfSpace: function (e, t, n) {
                var r, s, o = this, a = 0;
                i.config.IS_FIREFOX ? (s = 2, a = 0, o.performHandleOuOfSpaceMainFunction(o, e, t, n, r, s, a)) : (s = 1, i.core.data.FSio.getUnUsedQuotaSpace(function (i) {
                    a = i, o.performHandleOuOfSpaceMainFunction(o, e, t, n, r, s, a)
                }))
            }, test: function () {
                var e, t = this;
                ...
                var n = 0, r = [], s = 0;
                for (this.sortArrayOfFilesObjectByLastModified(e.filesStats); n < e.size / 2 && s < e.filesStats.length;)if (-1 == e.filesStats[s].key.toString().indexOf(".fi"))if (this.isSafeToDeleteFile(e.filesStats[s])) {
                    r.push(e.filesStats[s]);
                    var o = this.findCorrespondingFileInfo(e.filesStats, e.filesStats[s].key + ".fi");
                    o && r.push(o), n += e.filesStats[s].size, s++
                } else s++; else s++;
                ...
                i.core.data.FSio.getLibraryStatistics(function (n) {
                    ...
                    for (var c in r.filesStats)if (a = Date.now() - r.filesStats[c].lastModified.getTime(), a > i.config.PERIODIC_CACHE_CLEANUP_PERIOD) {
                        o.push(r.filesStats[c]);
                        var l = t.findCorrespondingFileInfo(r.filesStats, r.filesStats[c].key + ".fi");
                        l && o.push(l), s += r.filesStats[c].size
                    }
                    i.core.data.FSio.deleteFiles(o, i.core.data.FSio, function (t) {
                        t ? e && e(!0) : e && e(!1)
                    })
                })
                ...
                return e.sort(function (e, t) {
                    var n = new Date(e.lastModified), i = new Date(t.lastModified);
                    return i > n ? -1 : n > i ? 1 : 0
                }), e
            }, getFileSizeFromArray: function (e, t) {
                var n = 0;
                for (var i in t)if (t[i].key == e) {
                    n = t[i].size;
                    break
                }
                return n
                ...
                var r = this, s = [], o = this.findCorrespondingFileInfo(t.filesStats, e), a = this.findCorrespondingFileInfo(t.filesStats, e + ".fi");
                o && s.push(o), a && s.push(a), o && (t.size -= o.size), a && (t.size -= a.size), this.spliceFileObjectFromArray(t.filesStats, e), this.spliceFileObjectFromArray(t.filesStats, e + ".fi"), i.core.data.FSio.deleteFiles(s, i.core.data.FSio, function (e) {
        ...
        function e(e, t) {
            var n = !1, i = !0, r = e.document, s = r.documentElement, o = r.addEventListener ? "addEventListener" : "attachEvent", a = r.addEventListener ? "removeEventListener" : "detachEvent", c = r.addEventListener ? "" : "on", l = function (i) {
            ...
            if ("complete" == r.readyState)t.call(e, "lazy"); else {
                if (r.createEventObject && s.doScroll && !r.addEventListener) {
                    try {
                        i = !e.frameElement
                    } catch (u) {
                    }
                ...
                r[o](c + "DOMContentLoaded", l, !1), r[o](c + "readystatechange", l, !1), e[o](c + "load", l, !1)
            }
        }
        ...
        function r() {
            s.resizing || (s.resizing = !0, window.requestAnimationFrame(function () {
                s.instances.forEach(function (e) {
        ...
        function s(e) {
            this.document_container = e, this.instances = [], this.$children = [], this.feedback_open = !1, this.elementInited = !1, s.instances.push(this)
        }

        function o(n) {
            var r = {}, s = n.Avg_Recv_P2P + n.Avg_Recv_HTTP, o = n.Total_Recv_No_Waste;
            this.size || (this.file_size = n.size, this.size = e(n.size), this.size_type = this.size.substring(this.size.length - 2), r.size = this.size), this.total_avg_download = n.Total_Avg_Download, this.disp_speed ? this.new_disp_speed = .9 * this.disp_speed + .1 * s : this.new_disp_speed = s, this.disp_speed = Math.floor(this.new_disp_speed), this.disp_speed < 10 && (this.disp_speed = 0);
            var a = this.disp_speed ? Math.floor((n.size - o) / this.disp_speed) : "Forever";
            ...
            var l = e(o, 1) + "";
            return this.completion_rate = o / n.size, r.downloaded = l, o < n.size ? r.progress = Math.round(o / n.size * 100) : (i.warn("FileUI trimmed the percentage to 100%"), r.progress = 100), r
        }

        function a(e, t) {
            var n = t.filename.split("."), r = n.pop();
        ...
        function c() {
            ...
            var e, t = document.body, n = window.getComputedStyle(t), i = "overflow", r = "visible";
        ...
        var l = "#428bca", d = 400, u = 8, h = "rgba(255,101,35,1)", f = 4, p = Math.PI, g = p / 180, m = !1, _ = "iso, tar, gz, lz, lzma, lzo, rz, xz, 7z, s7z, ace, apk, arc, arj" + ", ice, jar, rar, zip, zipx, cab, lzh, bz2, uue, z".split(", "), E = "webm, mkv, flv, ogv, ogg, avi, mov, qt, wmv, rm, rmvb, mp4, m4p" + ", m4v, mpg, mp2, mpeg, mpe, mpv, m2v, m4v, 3gp, 3g2".split(", "), v = "jpg, jpeg, jpe, jfif, gif, png, bmp, tif, tiff".split(", "), b = {
        ...
        window.matchMedia ? window.addEventListener("load", function () {
            if (window.matchMedia("only screen and (min-device-width : 320px) and (max-device-width : 640px) and (max-device-height: 768px)").matches) {
                m = !0;
                var e, t = document.querySelector("meta[name=viewport]"), n = {
                    width: "device-width",
                    "user-scalable": "no",
                    "initial-scale": "1"
                }, i = [], r = !1;
        ...
        }, !1) : window.addEventListener("resize", r, !1), s.instances = [], s.prototype._initElement = function () {
        ...
        }, s.prototype.checkPanesWidth = function () {
            if (!m) {
            ...
            var e, t = "p5-dl-checked", i = !1, r = function () {
                this.checkPanesWidth(), this.resize(), i && window.requestAnimationFrame(r)
            }.bind(this), s = function () {
                i = !1
            }, o = function (e) {
                this.feedback_open = !this.feedback_open, null == S && setTimeout(s, 300), this.$container.classList.toggle("p5-dl-feedback-opened"), i = !0, window.requestAnimationFrame(r)
            }.bind(this), a = function (e) {
                this.$submit.removeEventListener("click", a, !1);
                var t = new XMLHttpRequest, i = this.serializeFeedbackForm();
            ...
            if (isNaN(t))this.$speed.textContent = ""; else {
                var n = t > 1048576 ? 2 : 0;
            ...
            var t = Math.floor(e / this.chunks_in_block), n = this.drawn[t];
            n || (n = this.drawn[t] = []), ~n.indexOf(e) || (n.push(e), this.drawBlock(t))
        }, a.prototype.drawBlock = function (e) {
            var t = this.canvas_width / this.num_of_blocks, n = this.drawn[e].length / this.chunks_in_block, i = (e * t | 0) % this.canvas_width;
            this.paint(i, t * n)
            ...
            constructor: {value: c}, _initCanvas: {
                value: function () {
                    var e = n(".p5-dl-progress", this.$el)[0], t = document.createElement("canvas"), i = window.getComputedStyle(e);
                ...
                value: function (e) {
                    var t = 360 / this.num_of_blocks, n = this.drawn[e].length / this.chunks_in_block, i = e * t % 360, r = i + n * t;
                    this.paint(i, r)
                }, enumerable: !0
            }, fillBuffer: {
                value: function (e, t) {
        ...
        }), i.client.downloader.PaneManager = s
    }(),i.client.downloader.AdManager = Object.subClass({
        name: "peer5.client.downloader.AdManager", ctor: function (e) {
            this.container = e
            ...
            isNaN(e) ? this.delay = 0 : this.delay = e, isNaN(t) ? this.refresh = 0 : this.refresh = t, thi$ = this, setTimeout(s, this.delay)
        }, stop: function () {
        }
    }),function () {
        function e() {
            function e() {
                s += Math.round(2 * Math.random() - 1), document.querySelector(".peer5_users_counter").innerHTML = s
            }

            var n = document.head, r = document.createElement("style");
            if (r.innerHTML = "@import url(//fonts.googleapis.com/css?family=Exo+2:200);.p5-dl-file,.p5-dl-stats-datum{white-space:nowrap;overflow:hidden}.p5-dl-container,.p5-dl-feedback-comment{font-family:'Exo 2',sans-serif!important}body.p5-dl-fixed{padding-bottom:144px!important}.p5-dl-container{position:fixed;bottom:0;left:0;right:0;z-index:2147483647;height:144px;padding:0;margin:0;background-color:#000;font-size:16px!important;text-transform:uppercase}.p5-dl-container *{margin:0;padding:0;color:#EEE;font-weight:400}.p5-dl-button,.p5-dl-feedback-form p{font-weight:700}.p5-dl-main-wrapper{position:absolute;top:0;bottom:0;left:0;right:234px;z-index:-1;overflow:hidden;-webkit-transition:right .3s ease-in-out 0s;transition:right .3s ease-in-out 0s}.p5-dl-feedback-opened .p5-dl-main-wrapper{right:500px}.p5-dl-main-wrapper.p5-dl-fixed-panes{overflow-x:auto;overflow-y:hidden}.p5-dl-scroller{display:none;position:absolute;bottom:0;left:0;right:233px;height:10px;background-color:#58585B}.p5-dl-grip{display:block;position:absolute;bottom:2px;left:4px;width:20%;height:6px;border-radius:3px;background-color:#AAA}.p5-dl-main{list-style:none;position:absolute;top:0;bottom:0;left:0;z-index:-1;width:100%;white-space:nowrap}.p5-dl-fixed-panes .p5-dl-main{width:auto;min-width:100%}.p5-dl-pane{display:inline-block;position:relative;z-index:-1;height:100%;width:100%;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;background-color:#58585B}.p5-dl-button,.p5-dl-extra-speed{-webkit-box-sizing:border-box;-moz-box-sizing:border-box}.p5-dl-pane+.p5-dl-pane{margin-left:6px}.p5-dl-fixed-panes .p5-dl-pane{width:400px}.p5-dl-pane canvas.boxes{position:absolute;left:0;right:0;top:0}.p5-dl-pane canvas.arcs{position:absolute;top:25px;left:10px}.p5-dl-fixed-panes .p5-dl-pane canvas.arcs{top:10px}.p5-dl-progress{display:inline-block;position:absolute;left:20px;top:35px;overflow:hidden;width:83px;height:83px;border:none;border-radius:83px;-webkit-box-shadow:inset 0 0 0 4px #FFF;-moz-box-shadow:inset 0 0 0 4px #FFF;box-shadow:inset 0 0 0 4px #FFF}.p5-dl-button,.p5-dl-progress-label{display:block;position:absolute;text-align:center}.p5-dl-fixed-panes .p5-dl-progress{top:20px}.p5-dl-progress-fill{position:absolute;bottom:4px;left:0;right:0;z-index:-1;background-color:#FF6523}.p5-dl-progress-label{z-index:1;width:100%;height:50%;padding-top:15px;font-size:19px;color:#DFE0E1}.p5-dl-button{z-index:2;width:100%;height:100%;padding-top:45px;font-size:24px;color:#FFF;box-sizing:border-box;cursor:pointer}.p5-dl-ad-overlay{position:fixed;top:0;left:0;width:100%;height:100%;background-color:#000;filter:alpha(opacity=50);-moz-opacity:.5;-khtml-opacity:.5;opacity:.5;z-index:0}.p5-dl-ad-display{position:fixed;bottom:141px;z-index:10001;left:50%;transform:translate(-50%)}.p5-dl-ad-display-smpl1,.p5-dl-ad-display-smpl2{height:90px;width:728px;position:fixed;bottom:144px;z-index:10001;left:50.7%;transform:translate(-50%);background-size:100% auto}.p5-dl-ad-display-smpl1{background-image:url(https://api.peer5.com/downloader/icons/ads/VLCbanner.png)}.p5-dl-ad-display-smpl2{background-image:url(https://api.peer5.com/downloader/icons/ads/Megaglest1.png)}.p5-dl-ad-display-close{right:2px;top:2px;width:20px;height:20px;padding:0;background:url(https://api.peer5.com/downloader/icons/x_button.svg) left top no-repeat;background-size:cover}.p5-dl-close-pane{right:12px;top:12px;width:20px;height:20px;padding:0;background:url(https://api.peer5.com/downloader/icons/x_button.svg) left top no-repeat;background-size:cover}.p5-dl-pause{background:url(https://api.peer5.com/downloader/icons/pause-white.svg) center 70% no-repeat;background-size:40% auto}.p5-dl-play{display:none;background:url(https://api.peer5.com/downloader/icons/play-white.svg) center 70% no-repeat;background-size:40% auto}.p5-dl-done{background:url(https://api.peer5.com/downloader/icons/v-white.svg) center 70% no-repeat;background-size:40% auto;cursor:default}.p5-dl-meta{display:inline-block;position:absolute;top:20px;bottom:20px;right:13px;left:123px}.p5-dl-fixed-panes .p5-dl-meta{top:10px;bottom:10px}.p5-dl-extra-speed{display:none;position:absolute;bottom:-8px;left:5%;min-width:90%;padding:2px 4px;font-size:10px;text-align:center;background-color:#FF6523;color:#111;box-sizing:border-box}.p5-dl-has-peers .p5-dl-extra-speed{display:block}.p5-dl-pane.p5-dl-only-child .p5-dl-extra-speed{font-size:13px;bottom:-46px}.p5-dl-file{position:absolute;top:0;left:2px;right:0;height:40px;line-height:40px;font-size:20px;text-overflow:ellipsis;text-align:center}.p5-dl-filename{color:#FFF}.p5-dl-pane.p5-dl-only-child .p5-dl-file{right:51%;height:104px;line-height:111px;font-size:23px}.p5-dl-pane.p5-dl-only-child .p5-dl-file:after,.p5-dl-pane.p5-dl-only-child .p5-dl-file:before{content:\"\";position:absolute;top:15px;bottom:15px;right:0;border-right:1px solid #979797}.p5-dl-pane.p5-dl-only-child .p5-dl-file:before{right:auto;left:0}.p5-dl-em{color:#FF6523}.p5-dl-stats{position:absolute;top:40px;bottom:0;left:0;right:0}.p5-dl-pane.p5-dl-only-child .p5-dl-stats{top:0;left:50%;height:104px}.p5-dl-stats-datum{display:inline-block;width:25%;height:60px;padding:34px 4px 0;font-size:11px;text-overflow:ellipsis;text-align:center;vertical-align:top;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;background-repeat:no-repeat;background-size:30px auto;background-position:center 6px}.p5-dl-pane.p5-dl-only-child .p5-dl-stats-peers,.p5-dl-pane.p5-dl-only-child .p5-dl-stats-size,.p5-dl-pane.p5-dl-only-child .p5-dl-stats-speed,.p5-dl-pane.p5-dl-only-child .p5-dl-stats-time{background-position:center 26px}.p5-dl-pane.p5-dl-only-child .p5-dl-stats-datum{height:104px;padding:60px 6px 20px;line-height:100%;font-size:16px;background-size:40px auto}.p5-dl-stats-time{background-image:url(https://api.peer5.com/downloader/icons/timer.svg)}.p5-dl-stats-speed{width:50%;background-image:url(https://api.peer5.com/downloader/icons/speedometer.svg)}.p5-dl-stats-size{background-image:url(https://api.peer5.com/downloader/icons/doc.svg)}.p5-dl-stats-size.p5-dl-zip{background-image:url(https://api.peer5.com/downloader/icons/zip.svg)}.p5-dl-stats-size.p5-dl-media{background-image:url(https://api.peer5.com/downloader/icons/media.svg)}.p5-dl-stats-size.p5-dl-pic{background-image:url(https://api.peer5.com/downloader/icons/pic.svg)}.p5-dl-peers-speed{display:inline-block;position:relative;width:50%;height:60px}.p5-dl-feedback,.p5-dl-stats-message{position:absolute;text-align:center;-webkit-box-sizing:border-box;-moz-box-sizing:border-box}.p5-dl-stats-peers{width:50%;background-image:url(https://api.peer5.com/downloader/icons/peer-deactivated.svg)}.p5-dl-has-peers .p5-dl-stats-peers{background-image:url(https://api.peer5.com/downloader/icons/peer-activated.svg)}.p5-dl-has-peers .p5-dl-stats-speed{background-image:url(https://api.peer5.com/downloader/icons/speedometer-extra.svg)}.p5-dl-stats-message{width:90%;margin:0 auto;bottom:-8px;right:6px;left:6px;line-height:150%;font-size:13px;background-color:#999;color:#FFF;box-sizing:border-box}.p5-dl-pane.p5-dl-only-child .p5-dl-stats-message{bottom:0}.p5-dl-completed .p5-dl-stats-message{background-color:#FF6523;color:#111}.p5-dl-feedback{top:0;bottom:0;right:0;width:234px;padding:20px 0;border:6px solid #000;background-color:#000;box-sizing:border-box;-webkit-box-shadow:-5px 0 4px 0 rgba(0,0,0,.5);-moz-box-shadow:-5px 0 4px 0 rgba(0,0,0,.5);box-shadow:-5px 0 4px 0 rgba(0,0,0,.5);-webkit-transition:width .3s ease-in-out 0s;transition:width .3s ease-in-out 0s}.p5-dl-feedback-opened .p5-dl-feedback{width:500px}.p5-dl-brand{display:inline-block;width:116px;height:30px;line-height:30px;text-align:left;background:url(https://api.peer5.com/downloader/icons/logo.svg) left top no-repeat}.p5-dl-need-help{font-size:23px}.p5-dl-brand:before{content:\"BY\";font-size:23px}.p5-dl-feedback-form{height:30px;text-align:center}.p5-dl-feedback-left{position:relative;top:0;left:0;width:234px}.p5-dl-feedback-right{position:absolute;top:20px;right:0;left:234px;padding:0 20px}.p5-dl-feedback-open{display:inline-block;width:26px;height:26px;background:url(https://api.peer5.com/downloader/icons/speech_bubble.svg) center center no-repeat;cursor:pointer}.p5-dl-feedback-form ul{display:inline-block;vertical-align:top;list-style:none}.p5-dl-feedback-form li{display:inline-block;width:26px;text-align:center}.p5-dl-feedback-form li label{display:block;position:relative;width:26px;height:26px;cursor:pointer}.p5-dl-feedback-form li label:after{position:absolute;content:'';display:block;top:0;width:30px;height:25px;background:url(https://api.peer5.com/downloader/icons/empty_feedback_star.svg) center center no-repeat}.p5-dl-feedback-form ul.p5-dl-checked label:after{background:url(https://api.peer5.com/downloader/icons/orange_feedback_star.svg) center center no-repeat}.p5-dl-feedback-form li.p5-dl-checked~li label:after{background:url(https://api.peer5.com/downloader/icons/empty_feedback_star.svg) center center no-repeat}.p5-dl-feedback-form ul.p5-dl-checked:hover label:after,.p5-dl-feedback-form ul:hover label:after{background:url(https://api.peer5.com/downloader/icons/orange_feedback_star.svg) center center no-repeat}.p5-dl-feedback-form .p5-dl-checked li:hover~li label:after,.p5-dl-feedback-form li:hover~li label:after{background:url(https://api.peer5.com/downloader/icons/empty_feedback_star.svg) center center no-repeat}.p5-dl-completed canvas,.p5-dl-feedback-submit{background-color:#FF6523}.p5-dl-feedback-form li input{visibility:hidden}.p5-dl-feedback-comment{display:block;padding:6px;width:100%;height:56px;margin-bottom:8px;border:none;resize:none;border-radius:6px;color:#000;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;font-weight:600}.p5-dl-feedback-submit{display:block;padding:2px 0;border-radius:6px;color:#fff;cursor:pointer}@media only screen and (min-device-width :320px) and (max-device-width :640px) and (max-device-height :768px){.p5-dl-completed canvas,.p5-dl-pane{background-color:transparent}::-webkit-input-placeholder{color:#474747}:-moz-placeholder{color:#474747;opacity:1}::-moz-placeholder{color:#474747;opacity:1}:-ms-input-placeholder{color:#474747}.p5-dl-container{height:auto;top:0}.p5-dl-feedback-open{display:none}.p5-dl-main-wrapper{right:0;bottom:200px;border:none}.p5-dl-feedback-opened .p5-dl-main-wrapper{right:0}.p5-dl-main{bottom:0}.p5-dl-pane canvas.arcs{position:absolute;top:50%;left:50%;margin:-65px 0 0 -85px}.p5-dl-progress{top:50%;left:50%;width:150px;height:150px;margin:-55px 0 0 -75px;border-radius:100px;-webkit-box-shadow:inset 0 0 0 6px #FFF;-moz-box-shadow:inset 0 0 0 6px #FFF;box-shadow:inset 0 0 0 6px #FFF}.p5-dl-progress-label{padding-top:30px}.p5-dl-progress-fill{background-color:#FF6523}.p5-dl-pause{padding-top:110px}.p5-dl-file{margin-top:10px;font-size:26px}.p5-dl-stats{top:50px}.p5-dl-pane.p5-dl-only-child .p5-dl-file:after{border:none}.p5-dl-em,.p5-dl-stats-size-total{color:#FF6523}.p5-dl-meta{top:0;bottom:0;left:0;right:0}.p5-dl-pane.p5-dl-only-child .p5-dl-stats{top:auto;left:0;height:80px;line-height:80px}.p5-dl-stats-datum{width:50%;padding:42px 4px 0;background-size:40px auto;font-size:16px}.p5-dl-peers-speed{position:absolute;bottom:12px;width:100%;padding-bottom:20px}.p5-dl-extra-speed{width:100%;left:0;bottom:-12px;font-size:18px}.p5-dl-stats-size,.p5-dl-stats-time{display:inline-block;width:50%;height:auto;padding:0;font-size:19px}.p5-dl-stats-size{text-align:center;background:0 0!important}.p5-dl-stats-time{background:0 0}.p5-dl-stats-message{left:0;right:0;bottom:0;width:100%}.p5-dl-feedback{top:auto;width:100%;height:200px;padding:10px 0;border:none;background-color:#666}.p5-dl-feedback-opened .p5-dl-feedback{width:100%}.p5-dl-feedback-right{position:static;margin-top:9px}.p5-dl-feedback-left{position:static;width:auto}.p5-dl-need-help{display:none}.p5-dl-feedback-form{top:0;left:50px;right:50px;height:auto;text-align:center}.p5-dl-feedback-form li:hover label:before{position:initial;content:initial;display:initial;top:initial;width:initial;height:initial;background:initial}.p5-dl-feedback-comment{display:block;width:100%;height:64px;padding:8px;background-color:#999;border:3px solid #777;border-radius:8px;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;font-family:'Exo 2',sans-serif!important}.p5-dl-feedback-submit{display:block;margin-top:12px;padding:3px 0;border-radius:8px;background-color:#FF6523;color:#fff;cursor:pointer;-webkit-box-shadow:0 1px 0 0 #000;-moz-box-shadow:0 1px 0 0 #000;box-shadow:0 1px 0 0 #000}.p5-dl-brand{position:absolute;bottom:10px;left:50%;margin-left:-58px;background:url(https://api.peer5.com/downloader/icons/logo.svg) left top no-repeat}}@media only screen and (min-device-width :320px) and (max-device-width :640px) and (max-device-height :768px) and (min-width :321px) and (orientation :landscape){.p5-dl-main-wrapper{bottom:12px}.p5-dl-stats-size,.p5-dl-stats-time{display:inline-block;width:50%}.p5-dl-brand,.p5-dl-feedback-opened .p5-dl-file{display:none}.p5-dl-feedback-opened .p5-dl-main-wrapper{right:0;bottom:200px}.p5-dl-feedback-opened .p5-dl-progress,.p5-dl-feedback-opened canvas.arcs{top:90%}.p5-dl-feedback-opened .p5-dl-stats{top:12px}.p5-dl-feedback-opened .p5-dl-peers-speed{padding-bottom:0}.p5-dl-feedback-opened .p5-dl-peers-speed .p5-dl-stats-datum{background-image:none}.p5-dl-feedback-opened .p5-dl-brand{display:block}.p5-dl-feedback{height:39px}.p5-dl-feedback-opened .p5-dl-feedback{height:200px;width:100%}.p5-dl-feedback-open{display:inline-block}}.p5-dl-hide{display:none!important}",
                    n.appendChild(r), t = new i.client.downloader.PaneManager(document.body), document.body.addEventListener("click", function (e) {
                ...
                var s = Math.floor(Date.now() / 3e4 % 9e5);
        ...
        i.download = function (e, t) {
            ...
            var s = n[e];
            if (s)i.warn(e + " was already existed in the filewrappers"), s.download(); else {
                var o = new i.client.downloader.FileWrapper(e, t);
                o.download(), n[e] = o
            }
        ...
        var t, n = {}, r = function () {
            var e = !1;
            i.core.util.envokeCallbackSync(s, []);
        ...
        window.onbeforeunload = r, i.client.downloader.FileWrapper = Object.subClass({
            ...
            ctor: function (e, t) {
                this.completed = !1, this.started = !1, this.fallback = !1, this.ui = null, this.url = e, this.swarmId = null, this.size = null, t.name ? this.filename = t.name : this.filename = "", this.options = t || {}, this.ui_events_cache = {
                    peer5_received_http_block: function (e, t, n) {
                        if (t == this.url)for (var r = e * (i.config.BLOCK_SIZE / i.config.CHUNK_SIZE), s = r + n / i.config.CHUNK_SIZE - 1, o = r; s >= o; o++)this.ui.paintHttp(o, 1)
            ...
            _download: function () {
                ...
                function n() {
                    if (!r.ui) {
                        var e = {
                            url: r.url, filename: r.filename, pause: function () {
                ...
                var r = this, s = {};
                this.options.sha1 ? s.sha1 = this.options.sha1 : this.options.md5 && (s.md5 = this.options.md5), (i.config.HTTP_ONLY || i.config.IS_CHROME && i.config.HTTP_ONLY_CHROME || i.config.IS_FIREFOX && i.config.HTTP_ONLY_FIREFOX) && (s.downloadMode = "http");
                var o = new i.Request(s);
                o.responseType = "blobUrl", o.onreadystatechange = function (t) {
                    if (!r.options || !r.options.disableUI) {
                        if (!r.swarmId && this.readyState >= 2) {
                            ...
                            try {
                                var s = e(this.getResponseHeader("content-disposition")), o = decodeURIComponent(s);
                                s && o && (r.filename = o)
                            } catch (t) {
                ...
                }, o.open("GET", this.url), n(), this.b1 = !1, this.p1 = !1, this.p5 = !1, this.p10 = !1, this.q1 = !1, this.q2 = !1, this.q3 = !1, this.q4 = !1, o.onprogress = function (e) {
