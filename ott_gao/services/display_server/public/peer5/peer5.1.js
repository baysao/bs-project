!function () {
    ...
    !function (e) {
        ...
        i.core.transport.WsConnection = Object.subClass({
            ...
            initiateWebSocket: function (e, t) {
                ...
                this.socket = {};//new WebSocket(a),
                    i.log("trying to connect to a new websocket"),
                    this.sessionid = t,
                    this.socket.binaryType = "arraybuffer",
                    this.socket.onclose = function (e) {
                        radio("router.disconnected").broadcast(),
                            i.warn("WebSocket closed with error"),
                            i.warn(e),
                            n.socket = null,
                        n.messageQueue.length > 0 && n.reconnect()
                    },
                    ...
                    this.socket.onopen = function () {
                        var e = Date.now();
                        n.state.connectionOpenTime = e - n.start, n.socketInitiating = !1, i.log("websocket took: " + n.state.connectionOpenTime + " to open"), n.socketInit = !0, n.registerServerNotifications(), radio("router.connected").broadcast(),
                            n.processQueue()
                    }
            },
            close: function () {
        ...
        i.client.DownloadUploadManager = Object.subClass({
            ...
            ctor: function () {
                if (this.clientId = i.core.util.generate_uuid(), this.registerEvents(), this.apiValidator = new i.core.apiValidators.ApiValidator({
                    ...
                    this.wsConnectionImpl = new i.core.transport.WsConnection(e, this.clientId),
                        this.controller = new i.client.HybridController(this.clientId),
                        this.resources = Object.create(null),
                        this.queuedResource = Object.create(null),
                        this.lastReportTime = Date.now(),
                        this.lastStatCalcTime = 0,
                        this.cron_interval_id = window.setInterval(this.cron, i.config.MONITOR_INTERVAL, this),
                        radio("peer5_uuid").broadcast(this.clientId)
                }
                ...
                i.core.data.FSio.executeOnReady({
                    ...
                    radio("scriptLoaded").broadcast(),
                    radio("scriptValidated").broadcast(this.validated)
                ...
                for (var t in i.core.data.BlockCache._blockMaps)e.resources[t] && 2 !== e.resources[t].mod && i.core.data.BlockCache.get(t) && !i.core.data.BlockCache.get(t).isFull() && (0 === i.core.stats.StatsCollector.statsCalculators[t].Avg_Recv_HTTP ? e.resources[t].httpIdle++ : e.resources[t].httpIdle = 0,
        ...
        e.PlaylistsHandler = function () {
            ...
            var g = Object.create(null), m = Object.create(null), v = null, _ = {segment: null, timeStamp: null};
        ...
        function t(e, t) {
            function o(e, t) {
                ...
                var o = {
                    onswarmstatechange: function (e) {
                        b.requestSwarmStateChanged(e)
                    }, onerror: function (e) {
                        S.reportRequestDone(n), t()
                    }, onabort: function (e) {
                        S.reportRequestDone(s), w.onRequestEvent("abort", e), t()
                    }, onload: function (e) {
                        S.reportRequestDone(r), w.onRequestEvent("load", e), 200 === e.currentTarget.status && b.saveDownloadSpeed(e.currentTarget), t()
                    }
            ...
            function a(e) {
                ...
                t.open("GET", e), t.onload = function () {
                    ...
                    if (s) {
                        E.extractSegments(e, this.response), s.rawContent = this.response, s.manifestUrl = e;
                        var o = t.isLiveMod(this.response);
                        o ? h(s) : (T.save(e, this.response),
                            p(s))
                    } else T.save(e, this.response), a(r[0])
                }, t.send()
            }
        ...
        var l = "#428bca", d = 400, u = 8, h = "rgba(255,101,35,1)", f = 4, p = Math.PI, g = p / 180, m = !1, v = "iso, tar, gz, lz, lzma, lzo, rz, xz, 7z, s7z, ace, apk, arc, arj" + ", ice, jar, rar, zip, zipx, cab, lzh, bz2, uue, z".split(", "), _ = "webm, mkv, flv, ogv, ogg, avi, mov, qt, wmv, rm, rmvb, mp4, m4p" + ", m4v, mpg, mp2, mpeg, mpe, mpv, m2v, m4v, 3gp, 3g2".split(", "), b = "jpg, jpeg, jpe, jfif, gif, png, bmp, tif, tiff".split(", "), E = {
        ...
        window.matchMedia ? window.addEventListener("load", function () {
            ...
            e.classList.add("p5-dl-container"), e.classList.add("p5-dl-hide"), e.innerHTML = E["p5-dl-container-template"], this.$el = n(".p5-dl-main", this.$container)[0], this.document_container.appendChild(e)
            ...
            this.$fileext.textContent = "." + e, ~v.indexOf(e) ? this.$file_type.classList.add("p5-dl-zip") : ~_.indexOf(e) ? this.$file_type.classList.add("p5-dl-media") : ~b.indexOf(e) && this.$file_type.classList.add("p5-dl-pic")
        ...
        window.onbeforeunload = r, i.client.downloader.FileWrapper = Object.subClass({
            name: "peer5.client.downloader.FileWrapper", ctor: function (e, t) {
