    ...
    !function (e) {
        ...
        i.core.transport.WsConnection = Object.subClass({
            ...
            initiateWebSocket: function (e, t) {
                ...
                console.log(a);
                a = 'wss://ws.peer5.com/?id=971c9d35-4fe8-4f09-9206-7a19057c56ba&token=ncp2vywz762cq79dgwd7&ver=0.53.29&conf=1.1.1&fallback=false&enabled=true&page=http%3A%2F%2Fdemo.peer5.com%2Fexamples%2Fvideo%2Fvideojs.html';
                this.socket = new WebSocket(a),
                    ...
                    this.socket.onerror = function (e) {
                        n.socketInitiating = !1,
                            i.warn("peer with Id " + n.sessionid + " had socket error")
                    },
