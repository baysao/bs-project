!function () {
    ...
    !function (e) {
        ...
        function E(e, t, n, i, r, s, o, a, c, l) {
        ...
        e.P2P_DATA = 17, e.P2P_REQUEST = 18, e.P2P_CANCEL = 19, e.P2P_HAVE = 20, e.P2P_HAVE_REQUEST = 21, e.P2P_DONT_HAVE = 22, e.P2P_VERSION = 23, e.FILE_INFO = 34, e.JOIN = 36, e.LEAVE = 37, e.CLOSE = 38, e.SWARM_HEALTH = 41, e.SWARM_ERROR = 48, e.SDP = 49, e.COMPLETED_DOWNLOAD = 50, e.GROUP_REPORT = 51, e.GROUP_MATCH = 52, e.HEAD = 53, e.HEAD_RESPONSE = 54, e.HEAD_ERROR = 55, e.GROUP_JOIN = 56, e.HEARTBEAT = 57, e.SHARE = 59, e.LEECH = 60, e.GROUP_SDP = 61, e.SWARM_NOT_FOUND = 0, e.SWARM_ONLY_DEVCHANNEL = 1, e.SWARM_ONLY_FIREFOX = 11, e.SWARM_ONLY_CHROME = 12, e.SWARM_NOT_COMPAT = 13, e.Have = r, e.HaveRequest = o, e.DontHave = s, e.Cancel = i, e.Request = n, e.Data = t, e.Version = C, e.GroupReport = c, e.SwarmReport = l, e.Connection = E, e.FileInfo = p, e.Share = g, e.GroupMatch = _, e.Join = d, e.Leech = u, e.GroupJoin = h, e.Leave = f, e.Sdp = v, e.GroupSdp = b, e.SwarmHealth = S, e.SwarmError = m, e.Head = T, e.HeadResponse = w, e.HeadError = R, e.Heartbeat = a
        ...
        var d = function (e, t) {
            ...
            return JSON.parse(r)
        }, A = {encode: R, decode: C}, P = {encode: y, decode: I}, O = {};
        O[s.P2P_DATA] = {encode: p, decode: v}, O[s.P2P_REQUEST] = {encode: g, decode: b}, O[s.P2P_CANCEL] = {
            encode: m,
            decode: S
        }, O[s.P2P_HAVE] = {encode: _, decode: T}, O[s.P2P_DONT_HAVE] = {
            encode: E,
            decode: w
        }, O[s.P2P_VERSION] = A, O[s.P2P_HAVE_REQUEST] = A, O[s.REPORT] = A, O[s.MATCH] = A, O[s.SDP] = A, O[s.FILE_INFO] = P, O[s.SWARM_HEALTH] = A, O[s.SWARM_ERROR] = A, O[s.JOIN] = A;
        ...
        window.RTCPeerConnection = window.RTCPeerConnection || window.webkitRTCPeerConnection || window.mozRTCPeerConnection, window.RTCSessionDescription = window.RTCSessionDescription || window.mozRTCSessionDescription, window.RTCIceCandidate = window.RTCIceCandidate || window.mozRTCIceCandidate, i.core.transport.PeerConnectionImpl = i.core.transport.AbstractPeerConnection.subClass({
            ...
            createDataChannel: function () {
                i.info("createDataChannel"), this.dataChannel = this.peerConnection.createDataChannel(this.label, this.dataChannelOptions), i.debug("DataChannel with label " + this.dataChannel.label + " initiated locally."), this.hookupDataChannelEvents()
            },
            ...
            name: "peer5.core.stats.reportBuilder", ctor: function () {
                ...
                radio("speedEstimationCalculated").subscribe([function (e) {
                    ...
                    t.push({
                        ...
                        action: e.action,
                        duration: e.duration,
                        timeSinceLoaded: e.timeSinceLoaded
                    })
        ...
        i.core.stats.StatsCollector = Object.subClass({
            name: "peer5.core.stats.StatsCollector", ctor: function () {
                ...
                radio("resourceAdded").subscribe([function (e) {
                    ...
                    this.stats[e].end = performance.now(), this.setSpeed(e, t)
                }, this]), radio("external.player").subscribe([function (e) {
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            ctor: function (e, t) {
                ...
                if (this.prefetchFlag[e] && this.resourceState[e] === !0) {
                    var n = this.download(e, t);
                    n && 0 !== n || this.prefetchPendingResources(e, t)
                }
            ...
            }, ensurePeerConnectionInitialized: function (e, n) {
                if (!(this.peersBlacklist[e] || this.peerConnections[e] || this.initPeerConnections[e] || i.config.MAX_CONNECTIONS && Object.keys(this.peerConnections).length >= i.config.MAX_CONNECTIONS || "chrome" === i.browserName && i.config.MAX_PC_CREATE && this.numberOfPCCreated >= i.config.MAX_PC_CREATE)) {
                    if ("firefox" === i.browserName && t.length <= 0)return void this.allocateMorePC();
                    this.attemptedConnections[e] = this.attemptedConnections[e] + 1 || 1, this.initPeerConnections[e] = new this.peerConnectionImpl(this.clientId, e, n, t.shift()), this.initPeerConnections[e].ignore = !0, this.increaseCreatedPCCount(), t.length < i.config.PC_POOL_LOW && this.allocateMorePC(), n && this.initPeerConnections[e].setupCall()
                }
                ...
                if (this.canUpload(e) && !(i.config.EMULATE_LOSS && Math.random() < i.config.EMULATE_LOSS_PERCENTAGE)) {
                    ...
                    r++;
                    var a = this;
                    i.core.data.BlockCache.get(e).getChunk(o, function (c, l) {
                        s += l.length;
                ...
                var t = new i.core.protocol.Version("0.53.29", i.config.VERSION), n = i.core.protocol.BinaryProtocol.encode([t]);
                this.sendToPeer(e, n)
                ...
                var t = i.core.data.BlockCache.get(e);
                if (t) {
                    var n, r = i.clientInstance.resources[e] ? i.clientInstance.resources[e].hashUrl : null;
                    return n = t.isFull() ? new i.core.protocol.Have(e, !0, null, null, r) : new i.core.protocol.Have(e, !1, t.getSerializedMap(), null, r)
                }
            }, createDontHaveMessage: function (e) {
                var t = i.clientInstance.resources[e] ? i.clientInstance.resources[e].hashUrl : null, n = new i.core.protocol.DontHave(e, t);
                return n
                ...
                if (!this.allocatingPC) {
                    ...
                    var e = 0, n = setInterval(function () {
                        i.info("creating peerConnection for pool"), t.push(i.core.transport.PeerConnectionImpl.createPeerConnection()), e++, e > i.config.PC_POOL_SIZE && (clearInterval(n), this.allocatingPC = !1)
                    }.bind(this), i.config.PC_POOL_REGEN_INTERVAL)
                }
            }, ignoreByVersion: function (e, t) {
                return i.core.util.validateVersion(e.client) && i.core.util.validateVersion(e.conf) ? e.conf !== i.config.VERSION ? (i.warn("Connected to a client with a non matching configuration version"), void this.closeConnection(t, !0)) : 0 !== i.core.util.compareMajorVersionNumbers("0.53.29", e.client) ? (i.warn("Connected to a client with a non matching client major version"), void this.closeConnection(t, !0)) : void(this.peerConnections[t].ignore = !1) : (i.warn("Connected to a client with an invalid version"), void this.closeConnection(t, !0))
        ...
        i.client.HTTPDownloader = Object.subClass({
            name: "peer5.client.HTTPDownloader", ctor: function (e) {
                ...
                this.xhr.onload = function (t) {
                    ...
                    200 === this.status || 206 === this.status ? radio("responseHeadersReceived" + this.url).broadcast(n) : (n.indexOf("X-Peer5-Proxy") > -1 && 404 !== this.status && i.feature.disable(i.config.FEATURE_PROXY_HEAD_KEY), i.warn("Expecting status code 200/206 from HEAD request. Got " + this.status), radio("xhrFailed" + this.url).broadcast(this)), e.stop()
                ...
                this.xhr.busy = !0, n ? this.xhr.setRequestHeader("Range", "bytes=" + t + "-" + n) : t && t > 0 ? this.xhr.setRequestHeader("Range", "bytes=" + t + "-") : t = 0, this.xhr.startRange = t, this.xhr.endRange = n, (!this.xhr.lastTotalLoaded || t > this.xhr.lastTotalLoaded || n < this.xhr.lastTotalLoaded) && (this.xhr.lastTotalLoaded = t), this.xhr.onloadend = function (e) {
                    i.debug("xhr onloadend start: " + this.startRange + " end: " + this.endRange)
                }, this.xhr.onabort = function (e) {
                    i.debug("xhr onabort")
                }, this.xhr.onerror = function (e) {
                    this.busy = !1, i.warn("xhr onerror!"), radio("xhrFailed" + this.url).broadcast(this)
                ...
                }, this.xhr.responseType = "arraybuffer", this.xhr.onload = function (e) {
                    i.log("onload xhr"), this.busy = !1, s.httpRequestTime = 0, this.status < 300 && this.status >= 200 && this.response ? (i.info("xhr onload: " + this.url + "start= " + this.start + "end= " + this.end), radio("bytesReceivedEvent" + this.url).broadcast({
                        url: this.url,
                        offset: this.startRange,
                        dataArray: new Uint8Array(this.response)
                    })) : (i.warn("could not determine file size from HTTP"), radio("xhrFailed" + this.url).broadcast(this))
                    ...
                    i.debug("onprogress size" + r), r > 0 && (radio("xhrBytesReceived" + this.url).broadcast(this.url, r), t.target.lastTotalLoaded = t.loaded + t.target.startRange, radio("onprogressEvent " + this.url).broadcast()), i.debug("HTTPDownloader::xhr.onprogress", t.loaded)
        ...
        function e(e, n) {
            if (e in t) {
                ...
                for (i in n) {
                    if (!(i in r))return !1;
                    if (typeof n[i] !== r[i])return !1
                }
                for (i in r) {
                    if (!(i in n))return !1;
                    if (r[i] !== typeof n[i])return !1
                }
                return !0
            }
            return !1
        ...
        var t = {
            player: {
                ...
                vendor: "string",
                id: "string"
            }, playback: {currentSegment: "string"}
        };
        ...
        i.client.DownloadUploadManager = Object.subClass({
            name: "peer5.client.DownloadUploadManager", ctor: function () {
                ...
                if (void 0 !== this.resources[e]) {
                    if (i.info("removeResource: removing resource " + e + " with state: " + this.resources[e].state),
                            !this.resources[e])return void i.error("tried to remove a resource that was already removed: " + e);
                ...
                if (i.info("initializing http resource: " + e), this.resources[e].hash && this.resources[e].length) {
                    var t = new i.core.protocol.FileInfo(this.resources[e].hash, this.resources[e].length, this.resources[e].hash, null, i.config.BLOCK_SIZE, e);
                    this.joinSwarm(t.swarmId), this.handleFileInfo(t)
                } else {
                    var n = function (e) {
                        this.joinSwarm(e.swarmId), this.handleFileInfo(e)
                    }.bind(this);
                    i.client.getHttpMeta(e, this.resources, n)
                }
            }, createAndUploadFileInfo: function (e) {
                var n = this.resources[e].hashAlg.end();
                t.addMapping(e, n), this.resources[e].hash = n, this.changeResourceId(e, this.resources[e].hash);
                var r = i.core.data.BlockCache.get(e), s = new i.core.protocol.Share(this.resources[e].hash, r.fileSize, this.resources[e].hash, this.resources[e].blockHashes, i.config.BLOCK_SIZE);
                return this.wsConnectionImpl.sendMessage(s), s
                ...
                i.log("slice"), this.resources[e].hashAlg.append(t);
                for (var r = i.core.data.BlockCache.get(e), s = Math.ceil(t.byteLength / i.config.CHUNK_SIZE), o = 0; s > o; o++) {
                    var a = o * i.config.CHUNK_SIZE, c = new Uint8Array(t.slice(a, Math.min(a + i.config.CHUNK_SIZE, t.byteLength))), l = r.setChunk(this.resources[e].chunkRead, c), d = r.ingestBlock(l);
                    d && (this.resources[e].blockHashes[l] = d), radio("chunkAddedToBlockMap").broadcast(), this.resources[e].chunkRead++
                }
                this.resources[e].chunkRead == this.numOfChunksInFile && (this.hasEntireFile = !0), r.fs ? i.core.data.FSio.notifyFinishWrite(n) : n()
            }, cron: function (e) {
                e.sendReportPeriodically(), e.calculateStats(), radio("cron").broadcast();
                for (var t in i.core.data.BlockCache._blockMaps)e.resources[t] && 2 !== e.resources[t].mod && i.core.data.BlockCache.get(t) && !i.core.data.BlockCache.get(t).isFull() && (0 === i.core.stats.StatsCollector.statsCalculators[t].Avg_Recv_HTTP ? e.resources[t].httpIdle++ : e.resources[t].httpIdle = 0, e.resources[t].httpIdle >= i.config.HTTP_IDLE_RESET_DURATION / i.config.MONITOR_INTERVAL && (e.controller.stopHttp(i.core.data.BlockCache.get(t).getMetadata().url), e.resources[t].httpIdle = 0), e.controller.downloadPeriodicTest(i.core.data.BlockCache.get(t).getMetadata().url))
        ...
        return e instanceof i.goog.Uri.QueryData ? this.queryData_ = e : (t || (e = i.goog.Uri.encodeSpecialChars_(e, i.goog.Uri.reDisallowedInQuery_)),
            this.queryData_ = new i.goog.Uri.QueryData(e, null)), this
        ...
        e.PlaylistsHandler = function () {
            ...
            function n(e) {
                E.segment = e, E.timeStamp = Date.now()
            }
            ...
            function a(e) {
                if (!_)return null;
                var t = m[_], n = g[t], i = n.getIndex(e);
                if (-1 === i)return null;
                var r = n.getIndex(_);
                return i - r
            }
            ...
            function c(e) {
                if (!_ || 0 >= e)return [];
                var t = m[_], n = g[t], i = n.getSegmentsInterval(_, e);
                return i
            }

            function l(e) {
                if (!_ || 0 >= e)return null;
                var t = m[_], n = g[t], i = n.getSegmentsDataInterval(_, e);
            ...
            function d() {
                if (!_)return !1;
                var e = m[_], t = g[e], n = t.getIndex(_);
                return n > -1
            }
            ...
            function p() {
                ...
                for (var n = (Date.now() - E.timeStamp) / 1e3, i = t.segmentData.duration - n, r = m[e], s = g[r], o = s.getSegments(), a = o.indexOf(e), c = 0, l = a + 1; l < o.length; l++) {
                    var d = o[l], u = f(d);
            ...
            var g = Object.create(null), m = Object.create(null), _ = null, E = {segment: null, timeStamp: null};
        ...
        function t(e, t) {
            function o(e, t) {
                ...
                return S.useP2PSlot(), w[c._segmentData.segment] = c, c
            }
            ...
            function u() {
                if (!C) {
                    for (var e = null, t = d(); t < E.segments.length && (e = E.segments[t], w[e]); t++);
            ...
            function h(e) {
                E = e, u(), C || setTimeout(function () {
                    a(e.manifestUrl)
                }, i.config.PREFETCH_LIVE_INTERVAL_MS)
            }

            function f(e) {
                if (!C)for (var t = S.availableP2PSlots(); t > 0 && e.length > 0;) {
                    var n = e.shift();
                    o(n, function () {
                        f(e)
                    }), t--
            ...
            function _() {
                C = !0, Object.keys(w).forEach(function (e) {
                    var t = w[e];
                    4 !== t.readyState && t.abort()
                })
            }

            var E, v = t, b = e.playlistsHandler, S = e.prefetchSlotsHandler, T = e.prefetchSpeedEstimator, w = Object.create(null), R = e.playlistsCache, C = !1;
        ...
        function t(e) {
            ...
            function d() {
                if (i.config.FEATURE_LIMIT_SLOTS_BY_PEERS) {
                    var e = g(), t = E();
                    t > e && (w.availableP2PSlots++, b = !1, c(), o())
                } else w.availableP2PSlots++, b = !1, c(), o()
            }

            function u() {
                var e = g();
                e <= i.config.MINIMUM_P2P_SLOTS || (w.availableP2PSlots--, c(), o())
            }
            ...
            function h(e) {
                if (i.config.FEATURE_LIMIT_SLOTS_BY_PEERS) {
                    ...
                    w.availableP2PSlots -= n, c(), o()
                }
            }

            function f() {
                w.availableP2PSlots--, v++
            }
            ...
            function g() {
                var e = w.availableP2PSlots + v;
                return e
            }

            function m() {
                return w.availableP2PSlots
            }
            ...
            var E = e, v = 0, b = !1, S = 0, T = 0, w = {availableP2PSlots: i.config.INITIAL_P2P_SLOTS};
            return function () {
        ...
        i.core.apis.MediaFetcher = Object.subClass({
            ctor: function () {
                ...
                i.info("request " + e.currentTarget._url + " loaded"), 2 === e.currentTarget.downloadMode ? this._decreaseP2PPendingRequests() : this._decreaseHTTPPendingRequests(), this.reportProgress({
                    type: "fileDownloaded",
                    url: e.currentTarget._url,
                    loaded: e.loaded,
                    p2p: e.loadedP2P,
                ...
                var s;
                i.config.AGGRESSIVE_P2P && t > this.downloadSpeed[0] ? (i.info("override interception to p2p"), e.downloadMode = 2, s = i.config.P2P_TIMEOUT_DURATION, this._increaseP2PPendingRequests()) : (i.info("override interception to http"), e.downloadMode = 3, s = i.config.HTTP_TIMEOUT_DURATION, this._increaseHTTPPendingRequests()), i.config.REQUEST_TIMEOUT && setTimeout(function () {
        ...
        function c() {
            ...
            e = n.getPropertyValue(i), e != r && (this._old_body_overflow = e, t.style.setProperty(i, r, "important")),
                window.addEventListener("touchmove", this._touchMoveHandler, !1)
        }
        ...
        i.download = function (e, t) {
            ...
            if (r.href = e, e = r.href, t.name ? t.name = t.name.toString() : t.name = decodeURI(e.substr(e.lastIndexOf("/") + 1).split("?")[0].split("#")[0]), t.onFallback && "function" != typeof t.onFallback && (i.warn("options.onFallback is not a function - ignoring"),
                    t.onFallback = null), t.onDownloadComplete && "function" != typeof t.onDownloadComplete && (i.warn("options.onDownloadComplete is not a function - ignoring"), t.onDownloadComplete = null), t.md5) {
