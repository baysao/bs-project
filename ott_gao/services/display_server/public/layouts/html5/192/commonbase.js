...
function onReady() {
    ...
    var closeButton = document.querySelector('#apps1 .vbx-close-button');
    if (closeButton != null) {
        hideRollPromptButton = closeButton.cloneNode(true);
