...
if (typeof GaoTracker_log !== 'function') {
    // piwik_log = function (documentTitle, siteId, piwikUrl, customData) {
    GaoTracker_log = function (documentTitle, siteId, piwikUrl, customData) {
        'use strict';
        ...
        var option,
            piwikTracker = GaoTracker.getTracker(piwikUrl, siteId);
