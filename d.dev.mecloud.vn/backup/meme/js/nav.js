    ...
    g.fn.stick_in_parent = function (d) {
        ...
        B = function (a, d, h, v, y, l) {
            ...
            if (l !== v) return m = a.css("float"), q = g("<div />").css({
                ...
                var c, g, n, e;
                n = t.scrollTop()-1;//fix header top
                null != w && (g = n - w);
                w = n;
                s ? (e = n + l + b > v + h, p && !e && (p = !1, a.css({
                        ...
                        bottom: "",
                        top: b
                    }).trigger("sticky_kit:unbottom")), n < y &&
                    (s = !1, b = k, "left" !== m && "right" !== m || a.insertAfter(q), q.detach(), c = {
                        position: ""
...
callNavProfile = function() {
	$(".nav-profile").stick_in_parent()
		.on("sticky_kit:stick", function(e) {
			$(".nav-profile").css('top','56px');
		});
};
