$(document).ready(function () {
	...
	$('.switch_options').each(function() {
		...
		enb.on('click', function(){
			...
			$(this).closest('.col50pBox').find("#fieldDownSite").show();
			$(this).closest('.col50pBox').find("#fieldNotification").show();
		});
		...
		dsb.on('click', function(){
			...
			$(this).closest('.col50pBox').find("#fieldDownSite").hide();
			$(this).closest('.col50pBox').find("#fieldNotification").hide();
		});
