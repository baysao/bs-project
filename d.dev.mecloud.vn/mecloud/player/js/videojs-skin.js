...
(function(window, videojs) {
	...
	*/
	videoJsSkin = function(options) {
		...
		*/
		...
		function createContextMenu() {
			...
			dContextMenu.className = "vmp-context-menu";
			dContextMenu.id = "vmp-context-menu";
		...
		function onContextMenu() {
			playerOnBody.querySelector('.vmp-context-menu').classList.add("active");
			player.el_.querySelector('.mask-context-menu').style.display = "block";
		}
		
		function offContextMenu() {
			playerOnBody.querySelector('.vmp-context-menu').classList.remove("active");
		...
		*/
	    ...
	    if(window.location == window.top.location) {
	      ...
	      player.el_.querySelector('.vmp-resolution-button').classList.remove('withIframe');
	    }else {
	      console.log(player.el_.querySelector('.vmp-resolution-button'));
	      //window.player = player.el_.querySelector('.vmp-menu');
	      player.el_.querySelector('.vmp-resolution-button').classList.add('withIframe');
	    }
		...
		*/
		function positionMenu(e) {
			...
			var windowWidth;
			var windowHeight;
			var menu = playerOnBody.querySelector('#vmp-context-menu');
	...
	function updateSkinColor_(color) {
	    ...
	    var styleTag = document.getElementById('vmp-skin-color')
	    if (!styleTag){
	    	styleTag = document.createElement("style");
	    	styleTag.id = "vmp-skin-color";
