...
var Button = (function (_Component) {
  ...
  Button.prototype.buildCSSClass = function buildCSSClass() {
    return 'vmp-control vmp-button ' + _Component.prototype.buildCSSClass.call(this);
  };
...
var CloseButton = (function (_Button) {
  ...
  CloseButton.prototype.buildCSSClass = function buildCSSClass() {
    return 'vmp-close-button ' + _Button.prototype.buildCSSClass.call(this);
  };
 ...
 * ```html
 *     <div class="video-js">
 *       <div class="vmp-button">Button</div>
 *     </div>
 * ```
...
var Component = (function () {
   ...
   * ```
   * The benefit of using this over `vmpEvents.on(otherElement, 'eventName', myFunc)`
  ...
  Component.prototype.lockShowing = function lockShowing() {
    this.addClass('vmp-lock-showing');
    return this;
  };
  ...
  Component.prototype.unlockShowing = function unlockShowing() {
    this.removeClass('vmp-lock-showing');
    return this;
  };
  ...
  Component.prototype.setTimeout = function setTimeout(fn, timeout) {
    ...
    disposeFn.guid = 'vmp-timeout-' + timeoutId;
  ...
  Component.prototype.setInterval = function setInterval(fn, interval) {
    ...
    disposeFn.guid = 'vmp-interval-' + intervalId;
...
var FullscreenToggle = (function (_Button) {
  ...
  FullscreenToggle.prototype.buildCSSClass = function buildCSSClass() {
    return 'vmp-fullscreen-control ' + _Button.prototype.buildCSSClass.call(this);
  };
...
var LiveDisplay = (function (_Component) {
  ...
  LiveDisplay.prototype.createEl = function createEl() {
    var el = _Component.prototype.createEl.call(this, 'div', {
      className: 'vmp-live-control vmp-control'
    });

    this.contentEl_ = Dom.createEl('div', {
      className: 'vmp-live-display',
      innerHTML: '<span class="vmp-control-text">' + this.localize('Stream Type') + '</span>' + this.localize('LIVE')
    }, {
      'aria-live': 'off'
    });
...
var MuteToggle = (function (_Button) {
  ...
  MuteToggle.prototype.buildCSSClass = function buildCSSClass() {
    return 'vmp-mute-control ' + _Button.prototype.buildCSSClass.call(this);
  };
  ...
  MuteToggle.prototype.update = function update() {
    ...
    for (var i = 0; i < 4; i++) {
      Dom.removeElClass(this.el_, 'vmp-vol-' + i);
    }
    Dom.addElClass(this.el_, 'vmp-vol-' + level);
  };
...
var PlayToggle = (function (_Button) {
  ...
  PlayToggle.prototype.buildCSSClass = function buildCSSClass() {
    return 'vmp-play-control ' + _Button.prototype.buildCSSClass.call(this);
  };
  ...
  /**
   * Add the vmp-playing class to the element so it can change appearance
   *
   * @method handlePlay
   */

  PlayToggle.prototype.handlePlay = function handlePlay() {
    this.removeClass('vmp-paused');
    this.addClass('vmp-playing');
    this.controlText('Pause'); // change the button text to "Pause"
  };

  /**
   * Add the vmp-paused class to the element so it can change appearance
   *
   * @method handlePause
   */

  PlayToggle.prototype.handlePause = function handlePause() {
    this.removeClass('vmp-playing');
    this.addClass('vmp-paused');
...
var PlaybackRateMenuButton = (function (_MenuButton) {
  ...
  PlaybackRateMenuButton.prototype.createEl = function createEl() {
    ...
    this.labelEl_ = Dom.createEl('div', {
      className: 'vmp-playback-rate-value',
      innerHTML: 1.0
    });
  ...
  PlaybackRateMenuButton.prototype.buildCSSClass = function buildCSSClass() {
    return 'vmp-playback-rate ' + _MenuButton.prototype.buildCSSClass.call(this);
  };
...
var LoadProgressBar = (function (_Component) {
  ...
  LoadProgressBar.prototype.createEl = function createEl() {
    return _Component.prototype.createEl.call(this, 'div', {
      className: 'vmp-load-progress',
      innerHTML: '<span class="vmp-control-text"><span>' + this.localize('Loaded') + '</span>: 0%</span>'
    });
  };
...
var PlayProgressBar = (function (_Component) {
  ...
  PlayProgressBar.prototype.createEl = function createEl() {
    return _Component.prototype.createEl.call(this, 'div', {
      className: 'vmp-play-progress vmp-slider-bar',
      innerHTML: '<span class="vmp-control-text"><span>' + this.localize('Progress') + '</span>: 0%</span>'
    });
  };
...
var ProgressControl = (function (_Component) {
  ...
  ProgressControl.prototype.createEl = function createEl() {
    return _Component.prototype.createEl.call(this, 'div', {
      className: 'vmp-progress-control vmp-control'
    });
  };
...
var CustomControlSpacer = (function (_Spacer) {
  ...
  CustomControlSpacer.prototype.buildCSSClass = function buildCSSClass() {
    return 'vmp-custom-control-spacer ' + _Spacer.prototype.buildCSSClass.call(this);
  };
...
var Spacer = (function (_Component) {
  ...
  Spacer.prototype.buildCSSClass = function buildCSSClass() {
    return 'vmp-spacer ' + _Component.prototype.buildCSSClass.call(this);
  };
...
var CaptionSettingsMenuItem = (function (_TextTrackMenuItem) {
  ...
  function CaptionSettingsMenuItem(player, options) {
    ...
    this.addClass('vmp-texttrack-settings');
  }
...
var CaptionsButton = (function (_TextTrackButton) {
  ...
  CaptionsButton.prototype.buildCSSClass = function buildCSSClass() {
    return 'vmp-captions-button ' + _TextTrackButton.prototype.buildCSSClass.call(this);
  };
...
var ChaptersButton = (function (_TextTrackButton) {
  ...
  ChaptersButton.prototype.buildCSSClass = function buildCSSClass() {
    return 'vmp-chapters-button ' + _TextTrackButton.prototype.buildCSSClass.call(this);
  };
...
var ChaptersTrackMenuItem = (function (_MenuItem) {
  ...
  ChaptersTrackMenuItem.prototype.update = function update() {
    ...
    // vmp.log(currentTime, cue.startTime);
...
var SubtitlesButton = (function (_TextTrackButton) {
  ...
  SubtitlesButton.prototype.buildCSSClass = function buildCSSClass() {
    return 'vmp-subtitles-button ' + _TextTrackButton.prototype.buildCSSClass.call(this);
  };
...
var CurrentTimeDisplay = (function (_Component) {
  ...
  CurrentTimeDisplay.prototype.createEl = function createEl() {
    var el = _Component.prototype.createEl.call(this, 'div', {
      className: 'vmp-current-time vmp-time-control vmp-control'
    });

    this.contentEl_ = Dom.createEl('div', {
      className: 'vmp-current-time-display',
      // label the current time for screen reader users
      innerHTML: '<span class="vmp-control-text">Current Time </span>' + '0:00'
    }, {
  ...
  CurrentTimeDisplay.prototype.updateContent = function updateContent() {
    ...
    this.contentEl_.innerHTML = '<span class="vmp-control-text">' + localizedText + '</span> ' + formattedTime;
  };
...
var DurationDisplay = (function (_Component) {
  ...
  DurationDisplay.prototype.createEl = function createEl() {
    var el = _Component.prototype.createEl.call(this, 'div', {
      className: 'vmp-duration vmp-time-control vmp-control'
    });

    this.contentEl_ = Dom.createEl('div', {
      className: 'vmp-duration-display',
      // label the duration time for screen reader users
      innerHTML: '<span class="vmp-control-text">' + this.localize('Duration Time') + '</span> 0:00'
    }, {
      // tell screen readers not to automatically read the time as it changes
      'aria-live': 'off'
    });
  ...
  DurationDisplay.prototype.updateContent = function updateContent() {
    ...
    if (duration) {
      ...
      this.contentEl_.innerHTML = '<span class="vmp-control-text">' + localizedText + '</span> ' + formattedTime; // label the duration time for screen reader users
    }
  };
...
var RemainingTimeDisplay = (function (_Component) {
  ...
  RemainingTimeDisplay.prototype.createEl = function createEl() {
    var el = _Component.prototype.createEl.call(this, 'div', {
      className: 'vmp-remaining-time vmp-time-control vmp-control'
    });

    this.contentEl_ = Dom.createEl('div', {
      className: 'vmp-remaining-time-display',
      // label the remaining time for screen reader users
      innerHTML: '<span class="vmp-control-text">' + this.localize('Remaining Time') + '</span> -0:00'
    }, {
      // tell screen readers not to automatically read the time as it changes
      'aria-live': 'off'
    });
  ...
  RemainingTimeDisplay.prototype.updateContent = function updateContent() {
    ...
    // Allows for smooth scrubbing, when player can't keep up.
    // var time = (this.player_.scrubbing()) ? this.player_.getCache().currentTime : this.player_.currentTime();
    // this.contentEl_.innerHTML = vmp.formatTime(time, this.player_.duration());
  };
...
var TimeDivider = (function (_Component) {
  ...
  TimeDivider.prototype.createEl = function createEl() {
    return _Component.prototype.createEl.call(this, 'div', {
      className: 'vmp-time-control vmp-time-divider',
...
var VolumeBar = (function (_Slider) {
  ...
  VolumeBar.prototype.createEl = function createEl() {
    return _Slider.prototype.createEl.call(this, 'div', {
      className: 'vmp-volume-bar vmp-slider-bar'
    }, {
...
var VolumeControl = (function (_Component) {
  ...
  VolumeControl.prototype.createEl = function createEl() {
    return _Component.prototype.createEl.call(this, 'div', {
      className: 'vmp-volume-control vmp-control'
    });
  };
...
var VolumeLevel = (function (_Component) {
  ...
  VolumeLevel.prototype.createEl = function createEl() {
    return _Component.prototype.createEl.call(this, 'div', {
      className: 'vmp-volume-level',
      innerHTML: '<span class="vmp-control-text"></span>'
    });
  };
...
var VolumeMenuButton = (function (_MenuButton) {
  ...
  function VolumeMenuButton(player) {
    ...
    this.on(this.volumeBar, ['slideractive', 'focus'], function () {
      this.addClass('vmp-slider-active');
    });

    this.on(this.volumeBar, ['sliderinactive', 'blur'], function () {
      this.removeClass('vmp-slider-active');
    });
  }
  ...
  VolumeMenuButton.prototype.buildCSSClass = function buildCSSClass() {
    ...
    if (!!this.options_.vertical) {
      orientationClass = 'vmp-volume-menu-button-vertical';
    } else {
      orientationClass = 'vmp-volume-menu-button-horizontal';
    }

    return 'vmp-volume-menu-button ' + _MenuButton.prototype.buildCSSClass.call(this) + ' ' + orientationClass;
  };
...
var ErrorDisplay = (function (_ModalDialog) {
  ...
  ErrorDisplay.prototype.buildCSSClass = function buildCSSClass() {
    return 'vmp-error-display ' + _ModalDialog.prototype.buildCSSClass.call(this);
  };
...
var MenuButton = (function (_Button) {
  ...
  MenuButton.prototype.buildCSSClass = function buildCSSClass() {
    var menuButtonClass = 'vmp-menu-button';
    ...
    return 'vmp-menu-button ' + menuButtonClass + ' ' + _Button.prototype.buildCSSClass.call(this);
  };
...
var MenuItem = (function (_Button) {
  ...
  MenuItem.prototype.selected = function selected(_selected) {
    if (_selected) {
      this.addClass('vmp-selected');
      this.el_.setAttribute('aria-selected', true);
    } else {
      this.removeClass('vmp-selected');
...
var MODAL_CLASS_NAME = 'vmp-modal-dialog';
var ESC = 27;
...
var ModalDialog = (function (_Component) {
  ...
  function ModalDialog(player, options) {
    ...
    this.descEl_ = Dom.createEl('p', {
      className: MODAL_CLASS_NAME + '-description vmp-offscreen',
  ...
  ModalDialog.prototype.buildCSSClass = function buildCSSClass() {
    return MODAL_CLASS_NAME + ' vmp-hidden ' + _Component.prototype.buildCSSClass.call(this);
  };
...
var Player = (function (_Component) {
  ...
  function Player(tag, options, ready) {
    ...
    tag.id = tag.id || 'vmp_video_' + Guid.newGUID();
    ...
    if (this.controls()) {
      this.addClass('vmp-controls-enabled');
    } else {
      this.addClass('vmp-controls-disabled');
    }

    if (this.isAudio()) {
      this.addClass('vmp-audio');
    }

    if (this.flexNotSupported_()) {
      this.addClass('vmp-no-flex');
    }

    // TODO: Make this smarter. Toggle user state between touching/mousing
    // using events, since devices can have both touch and mouse events.
    // if (browser.TOUCH_ENABLED) {
    //   this.addClass('vmp-touch-enabled');
    // }
  ...
  Player.prototype.createEl = function createEl() {
    ...
    // Might think we should do this after embedding in container so .vmp-tech class
    // doesn't flash 100% width/height, but class only applies with .video-js parent
    tag.id += '_html5_api';
    tag.className = 'vmp-tech';
    ...
    // video element
    this.styleEl_ = stylesheet.createStyleElement('vmp-styles-dimensions');
    var defaultsStyleEl = Dom.$('.vmp-styles-defaults');
    var head = Dom.$('head');
  ...
  /**
   * Add/remove the vmp-fluid class
   *
  ...
  Player.prototype.fluid = function fluid(bool) {
    ...
    if (bool) {
      this.addClass('vmp-fluid');
    } else {
      this.removeClass('vmp-fluid');
    }
  };
  ...
  /**
   * Add/remove the vmp-has-started class
   *
  ...
  Player.prototype.hasStarted = function hasStarted(_hasStarted) {
    if (_hasStarted !== undefined) {
      ...
      if (this.hasStarted_ !== _hasStarted) {
        ...
        if (_hasStarted) {
          this.addClass('vmp-has-started');
          // trigger the firstplay event if this newly has played
          this.trigger('firstplay');
        } else {
          this.removeClass('vmp-has-started');
        }
      }
      return this;
    }
  ...
  Player.prototype.handleFullscreenChange_ = function handleFullscreenChange_() {
    if (this.isFullscreen()) {
      this.addClass('vmp-fullscreen');
    } else {
      this.removeClass('vmp-fullscreen');
    }
  };
  ...
  Player.prototype.scrubbing = function scrubbing(isScrubbing) {
    if (isScrubbing !== undefined) {
      ...
      if (isScrubbing) {
        this.addClass('vmp-scrubbing');
      } else {
        this.removeClass('vmp-scrubbing');
      }
  ...
  Player.prototype.duration = function duration(seconds) {
    ...
    if (seconds !== this.cache_.duration) {
      ...
      if (seconds === Infinity) {
        this.addClass('vmp-live');
      } else {
        this.removeClass('vmp-live');
      }
  ...
  Player.prototype.enterFullWindow = function enterFullWindow() {
    ...
    Dom.addElClass(_globalDocument2['default'].body, 'vmp-full-window');
  ...
  Player.prototype.exitFullWindow = function exitFullWindow() {
    ...
    Dom.removeElClass(_globalDocument2['default'].body, 'vmp-full-window');
  ...
  Player.prototype.controls = function controls(bool) {
    if (bool !== undefined) {
      ...
      if (this.controls_ !== bool) {
        ...
        if (bool) {
          this.removeClass('vmp-controls-disabled');
          this.addClass('vmp-controls-enabled');
          ...
          this.removeClass('vmp-controls-enabled');
          this.addClass('vmp-controls-disabled');
  ...
  Player.prototype.usingNativeControls = function usingNativeControls(bool) {
    if (bool !== undefined) {
      ...
      if (this.usingNativeControls_ !== bool) {
        ...
        if (bool) {
          this.addClass('vmp-using-native-controls');
          ...
          this.removeClass('vmp-using-native-controls');
  ...
  Player.prototype.error = function error(err) {
    ...
    // add the vmp-error classname to the player
    this.addClass('vmp-error');
    ...
    if (bool !== undefined) {
      ...
      if (bool !== this.userActive_) {
        ...
        if (bool) {
          ...
          // inactivity timer
          this.userActivity_ = true;
          this.removeClass('vmp-user-inactive');
          this.addClass('vmp-user-active');
          ...
          this.removeClass('vmp-user-active');
          this.addClass('vmp-user-inactive');
...
var autoSetupTimeout = function autoSetupTimeout(wait, vmp) {
  videojs = vmp;
...
var Slider = (function (_Component) {
  ...
  Slider.prototype.createEl = function createEl(type) {
    ...
    props.className = props.className + ' vmp-slider';
    props = _objectAssign2['default']({
      tabIndex: 0
    }, props);
  ...
  Slider.prototype.vertical = function vertical(bool) {
    ...
    if (this.vertical_) {
      this.addClass('vmp-slider-vertical');
    } else {
      this.addClass('vmp-slider-horizontal');
    }
...
var Flash = (function (_Tech) {
  ...
  Flash.prototype.createEl = function createEl() {
    ...
    if (!options.swf) {
      options.swf = '//vmp.zencdn.net/swf/5.0.1/video-js.swf';
    }
  ...
  Flash.prototype.setCurrentTime = function setCurrentTime(time) {
    ...
    if (seekable.length) {
      ...
      this.trigger('seeking');
      this.el_.vmp_setProperty('currentTime', time);
  ...
  Flash.prototype.currentTime = function currentTime(time) {
    ...
    return this.el_.vmp_getProperty('currentTime');
  };
  ...
  Flash.prototype.currentSrc = function currentSrc() {
    if (this.currentSource_) {
      ...
      return this.el_.vmp_getProperty('currentSrc');
    }
  };
  ...
  Flash.prototype.poster = function poster() {
    this.el_.vmp_getProperty('poster');
  };
  ...
  Flash.prototype.buffered = function buffered() {
    var ranges = this.el_.vmp_getProperty('buffered');
    if (ranges.length === 0) {
      return _utilsTimeRangesJs.createTimeRange();
    }
...
function _createSetter(attr) {
  ...
  _api['set' + attrUpper] = function (val) {
    return this.el_.vmp_setProperty(attr, val);
  };
}
function _createGetter(attr) {
  _api[attr] = function () {
    return this.el_.vmp_getProperty(attr);
  };
}
...
var Tech = (function (_Component) {
  ...
  Tech.prototype.emulateTextTracks = function emulateTextTracks() {
    ...
    if (!_globalWindow2['default']['WebVTT'] && this.el().parentNode != null) {
      ...
      script.src = this.options_['vtt.js'] || 'https://cdn.rawgit.com/gkatsev/vtt.js/vmp-v0.12.1/dist/vtt.min.js';
...
var TextTrackDisplay = (function (_Component) {
  ...
  */
  ...
  TextTrackDisplay.prototype.createEl = function createEl() {
    return _Component.prototype.createEl.call(this, 'div', {
      className: 'vmp-text-track-display'
    });
  };
...
var TextTrackSettings = (function (_Component) {
  ...
  function TextTrackSettings(player, options) {
    ...
    Events.on(this.$('.vmp-done-button'), 'click', Fn.bind(this, function () {
      this.saveSettings();
      this.hide();
    }));

    Events.on(this.$('.vmp-default-button'), 'click', Fn.bind(this, function () {
      this.$('.vmp-fg-color > select').selectedIndex = 0;
      this.$('.vmp-bg-color > select').selectedIndex = 0;
      this.$('.window-color > select').selectedIndex = 0;
      this.$('.vmp-text-opacity > select').selectedIndex = 0;
      this.$('.vmp-bg-opacity > select').selectedIndex = 0;
      this.$('.vmp-window-opacity > select').selectedIndex = 0;
      this.$('.vmp-edge-style select').selectedIndex = 0;
      this.$('.vmp-font-family select').selectedIndex = 0;
      this.$('.vmp-font-percent select').selectedIndex = 2;
      this.updateDisplay();
    }));

    Events.on(this.$('.vmp-fg-color > select'), 'change', Fn.bind(this, this.updateDisplay));
    Events.on(this.$('.vmp-bg-color > select'), 'change', Fn.bind(this, this.updateDisplay));
    Events.on(this.$('.window-color > select'), 'change', Fn.bind(this, this.updateDisplay));
    Events.on(this.$('.vmp-text-opacity > select'), 'change', Fn.bind(this, this.updateDisplay));
    Events.on(this.$('.vmp-bg-opacity > select'), 'change', Fn.bind(this, this.updateDisplay));
    Events.on(this.$('.vmp-window-opacity > select'), 'change', Fn.bind(this, this.updateDisplay));
    Events.on(this.$('.vmp-font-percent select'), 'change', Fn.bind(this, this.updateDisplay));
    Events.on(this.$('.vmp-edge-style select'), 'change', Fn.bind(this, this.updateDisplay));
    Events.on(this.$('.vmp-font-family select'), 'change', Fn.bind(this, this.updateDisplay));
  ...
  TextTrackSettings.prototype.createEl = function createEl() {
    return _Component.prototype.createEl.call(this, 'div', {
      className: 'vmp-caption-settings vmp-modal-overlay',
  ...
  TextTrackSettings.prototype.getValues = function getValues() {
    var textEdge = getSelectedOptionValue(this.$('.vmp-edge-style select'));
    var fontFamily = getSelectedOptionValue(this.$('.vmp-font-family select'));
    var fgColor = getSelectedOptionValue(this.$('.vmp-fg-color > select'));
    var textOpacity = getSelectedOptionValue(this.$('.vmp-text-opacity > select'));
    var bgColor = getSelectedOptionValue(this.$('.vmp-bg-color > select'));
    var bgOpacity = getSelectedOptionValue(this.$('.vmp-bg-opacity > select'));
    var windowColor = getSelectedOptionValue(this.$('.window-color > select'));
    var windowOpacity = getSelectedOptionValue(this.$('.vmp-window-opacity > select'));
    var fontPercent = _globalWindow2['default']['parseFloat'](getSelectedOptionValue(this.$('.vmp-font-percent > select')));
  ...
  TextTrackSettings.prototype.setValues = function setValues(values) {
    setSelectedOption(this.$('.vmp-edge-style select'), values.edgeStyle);
    setSelectedOption(this.$('.vmp-font-family select'), values.fontFamily);
    setSelectedOption(this.$('.vmp-fg-color > select'), values.color);
    setSelectedOption(this.$('.vmp-text-opacity > select'), values.textOpacity);
    setSelectedOption(this.$('.vmp-bg-color > select'), values.backgroundColor);
    setSelectedOption(this.$('.vmp-bg-opacity > select'), values.backgroundOpacity);
    setSelectedOption(this.$('.window-color > select'), values.windowColor);
    setSelectedOption(this.$('.vmp-window-opacity > select'), values.windowOpacity);
    ...
    setSelectedOption(this.$('.vmp-font-percent > select'), fontPercent);
  };
  ...
  TextTrackSettings.prototype.restoreSettings = function restoreSettings() {
    var _safeParseTuple = _safeJsonParseTuple2['default'](_globalWindow2['default'].localStorage.getItem('vmp-text-track-settings'));
  ...
  TextTrackSettings.prototype.saveSettings = function saveSettings() {
    ...
    try {
      if (Object.getOwnPropertyNames(values).length > 0) {
        _globalWindow2['default'].localStorage.setItem('vmp-text-track-settings', JSON.stringify(values));
      } else {
        _globalWindow2['default'].localStorage.removeItem('vmp-text-track-settings');
      }
    } catch (e) {}
  };
...
function captionOptionsMenuTemplate() {
  var template = '<div class="vmp-tracksettings">\n      <div class="vmp-tracksettings-colors">\n        <div class="vmp-fg-color vmp-tracksetting">\n            <label class="vmp-label">Foreground</label>\n            <select>\n              <option value="">---</option>\n              <option value="#FFF">White</option>\n              <option value="#000">Black</option>\n              <option value="#F00">Red</option>\n              <option value="#0F0">Green</option>\n              <option value="#00F">Blue</option>\n              <option value="#FF0">Yellow</option>\n              <option value="#F0F">Magenta</option>\n              <option value="#0FF">Cyan</option>\n            </select>\n            <span class="vmp-text-opacity vmp-opacity">\n              <select>\n                <option value="">---</option>\n                <option value="1">Opaque</option>\n                <option value="0.5">Semi-Opaque</option>\n              </select>\n            </span>\n        </div> <!-- vmp-fg-color -->\n        <div class="vmp-bg-color vmp-tracksetting">\n            <label class="vmp-label">Background</label>\n            <select>\n              <option value="">---</option>\n              <option value="#FFF">White</option>\n              <option value="#000">Black</option>\n              <option value="#F00">Red</option>\n              <option value="#0F0">Green</option>\n              <option value="#00F">Blue</option>\n              <option value="#FF0">Yellow</option>\n              <option value="#F0F">Magenta</option>\n              <option value="#0FF">Cyan</option>\n            </select>\n            <span class="vmp-bg-opacity vmp-opacity">\n                <select>\n                  <option value="">---</option>\n                  <option value="1">Opaque</option>\n                  <option value="0.5">Semi-Transparent</option>\n                  <option value="0">Transparent</option>\n                </select>\n            </span>\n        </div> <!-- vmp-bg-color -->\n        <div class="window-color vmp-tracksetting">\n            <label class="vmp-label">Window</label>\n            <select>\n              <option value="">---</option>\n              <option value="#FFF">White</option>\n              <option value="#000">Black</option>\n              <option value="#F00">Red</option>\n              <option value="#0F0">Green</option>\n              <option value="#00F">Blue</option>\n              <option value="#FF0">Yellow</option>\n              <option value="#F0F">Magenta</option>\n              <option value="#0FF">Cyan</option>\n            </select>\n            <span class="vmp-window-opacity vmp-opacity">\n                <select>\n                  <option value="">---</option>\n                  <option value="1">Opaque</option>\n                  <option value="0.5">Semi-Transparent</option>\n                  <option value="0">Transparent</option>\n                </select>\n            </span>\n        </div> <!-- vmp-window-color -->\n      </div> <!-- vmp-tracksettings -->\n      <div class="vmp-tracksettings-font">\n        <div class="vmp-font-percent vmp-tracksetting">\n          <label class="vmp-label">Font Size</label>\n          <select>\n            <option value="0.50">50%</option>\n            <option value="0.75">75%</option>\n            <option value="1.00" selected>100%</option>\n            <option value="1.25">125%</option>\n            <option value="1.50">150%</option>\n            <option value="1.75">175%</option>\n            <option value="2.00">200%</option>\n            <option value="3.00">300%</option>\n            <option value="4.00">400%</option>\n          </select>\n        </div> <!-- vmp-font-percent -->\n        <div class="vmp-edge-style vmp-tracksetting">\n          <label class="vmp-label">Text Edge Style</label>\n          <select>\n            <option value="none">None</option>\n            <option value="raised">Raised</option>\n            <option value="depressed">Depressed</option>\n            <option value="uniform">Uniform</option>\n            <option value="dropshadow">Dropshadow</option>\n          </select>\n        </div> <!-- vmp-edge-style -->\n        <div class="vmp-font-family vmp-tracksetting">\n          <label class="vmp-label">Font Family</label>\n          <select>\n            <option value="">Default</option>\n            <option value="monospaceSerif">Monospace Serif</option>\n            <option value="proportionalSerif">Proportional Serif</option>\n            <option value="monospaceSansSerif">Monospace Sans-Serif</option>\n            <option value="proportionalSansSerif">Proportional Sans-Serif</option>\n            <option value="casual">Casual</option>\n            <option value="script">Script</option>\n            <option value="small-caps">Small Caps</option>\n          </select>\n        </div> <!-- vmp-font-family -->\n      </div>\n    </div>\n    <div class="vmp-tracksettings-controls">\n      <button class="vmp-default-button">Defaults</button>\n      <button class="vmp-done-button">Done</button>\n    </div>';
...
var TextTrack = function TextTrack() {
  ...
  var id = options['id'] || 'vmp_text_track_' + Guid.newGUID();
...
// Add default styles
var style = Dom.$('.vmp-styles-defaults');
if (!style) {
  style = stylesheet.createStyleElement('vmp-styles-defaults');
  var head = Dom.$('head');
 ...
 * ```js
 *     var vmpButton = videojs.getComponent('Button');
 *     // Create a new instance of the component
 *     var myButton = new vmpButton(myPlayer);
 * ```
 *
 ...
 *     var MySpecialButton = videojs.extend(vmpButton, {});
 *     // Register the new component
 *     vmpButton.registerComponent('MySepcialButton', MySepcialButton);
 ...
 *     vmpButton.registerTech('Tech', MyTech);
